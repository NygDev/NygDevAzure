...
function getNearestOverflowAncestor(e) {
	let t = getParentNode(e);
	return isLastTraversableNode(t) ? (e.ownerDocument || e).body : isHTMLElement(t) && isOverflowElement(t) ? t : getNearestOverflowAncestor(t);
}
...
//#endregion
//#region ../../node_modules/.pnpm/@floating-ui+react@0.27.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@floating-ui/react/dist/floating-ui.react.utils.mjs
...
function getFloatingFocusElement(e) {
	return e ? e.hasAttribute(b) ? e : e.querySelector("[" + b + "]") || e : null;
}
...
var T = 50, E = /* @__PURE__ */ e(async (e, t, n) => {
	...
	async fn(t) {
		...
		let T = x / 2 - S / 2, E = w / 2 - g[h] / 2 - 1, D = d(f[v], E), O = d(f[y], E), k = w - g[h] - O, A = w / 2 - g[h] / 2 + T, j = clamp(D, A, k), M = !c.arrow && getAlignment(i) != null && A !== j && a.reference[h] / 2 - (A < D ? D : O) - g[h] / 2 < 0, N = M ? A < D ? A - D : A - k : 0;
		return {
			[m]: p[m] + N,
			data: {
				[m]: j,
...
function getPlacementList(e, t, n) {
	return (e ? [...n.filter((t) => getAlignment(t) === e), ...n.filter((t) => getAlignment(t) !== e)] : n.filter((e) => getSide(e) === e)).filter((n) => !e || getAlignment(n) === e || (t ? getOppositeAlignmentPlacement(n) !== n : !1));
}
var O = /* @__PURE__ */ e(function(e) {
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			let { rects: n, middlewareData: r, placement: i, platform: a, elements: o } = t, { crossAxis: s = !1, alignment: c, allowedPlacements: l = u, autoAlignment: d = !0, ...f } = evaluate(e, t), p = c !== void 0 || l === u ? getPlacementList(c || null, d, l) : l, m = r.autoPlacement?.index || 0, h = p[m];
			if (h == null) return {};
			if (i !== h) return { reset: { placement: p[0] } };
			let g = await a.detectOverflow(t, f), _ = getAlignmentSides(h, n, await (a.isRTL == null ? void 0 : a.isRTL(o.floating))), v = [
				g[getSide(h)],
				g[_[0]],
				g[_[1]]
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			...
			if (T = [...T, {
				...
				if (t && (u !== "alignment" || _ === getSideAxis(t) || T.every((e) => getSideAxis(e.placement) !== _ || e.overflows[0] > 0))) return {
					data: {
						index: e,
						overflows: T
					},
...
var j = /* @__PURE__ */ e(function(e) {
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			let { placement: n, elements: r, rects: i, platform: a, strategy: o } = t, { padding: s = 2, x: c, y: l } = evaluate(e, t), u = Array.from(await (a.getClientRects == null ? void 0 : a.getClientRects(r.reference)) || []);
			if (!u.length) return {};
			let p = getRectsByLine(u), m = rectToClientRect(getBoundingRect(u)), h = getPaddingObject(s);
			function getBoundingClientRect() {
				if (p.length === 2 && (p[0].left > p[1].right || p[1].left > p[0].right) && c != null && l != null) return p.find((e) => c > e.left - h.left && c < e.right + h.right && l > e.top - h.top && l < e.bottom + h.bottom) || m;
				if (p.length >= 2) {
					if (getSideAxis(n) === "y") {
						let e = p[0], t = p[p.length - 1], r = getSide(n) === "top", i = e.top, a = t.bottom, o = r ? e.left : t.left;
					...
					let e = getSide(n) === "left", t = f(...p.map((e) => e.right)), r = d(...p.map((e) => e.left)), i = p.filter((n) => e ? n.left === r : n.right === t), a = i[0].top, o = i[i.length - 1].bottom;
					return rectToClientRect({
						x: r,
						y: a,
						width: t - r,
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			let { x: n, y: r, placement: i, platform: a } = t, { mainAxis: o = !0, crossAxis: s = !1, limiter: c = { fn: (e) => {
				...
				x: n,
				y: r
			}, d = await a.detectOverflow(t, l), f = getSideAxis(i), p = getOppositeAxis(f), m = u[p], h = u[f], clampCoord = (e, t) => clamp(t + d[e === "y" ? "top" : "left"], t, t - d[e === "y" ? "bottom" : "right"]);
			o && (m = clampCoord(p, m)), s && (h = clampCoord(f, h));
			let g = c.fn({
				...t,
				[p]: m,
				[f]: h
...
}, "limitShift"), I = /* @__PURE__ */ e(function(e) {
	return e === void 0 && (e = {}), {
		name: "size",
		options: e,
		async fn(t) {
			let { placement: n, rects: r, platform: i, elements: a } = t, { apply = () => {}, ...o } = evaluate(e, t), s = await i.detectOverflow(t, o), c = getSide(n), l = getAlignment(n), u = getSideAxis(n) === "y", { width: p, height: m } = r.floating, h, g;
			c === "top" || c === "bottom" ? (h = c, g = l === (await (i.isRTL == null ? void 0 : i.isRTL(a.floating)) ? "start" : "end") ? "left" : "right") : (g = c, h = l === "end" ? "top" : "bottom");
			let _ = m - s.top - s.bottom, v = p - s.left - s.right, y = d(m - s[h], _), b = d(p - s[g], v), x = t.middlewareData.shift, S = !x, C = y, w = b;
			x != null && x.enabled.x && (w = v), x != null && x.enabled.y && (C = _), S && !l && (u ? w = p - 2 * f(s.left, s.right) : C = m - 2 * f(s.top, s.bottom)), await apply({
				...t,
				availableWidth: w,
				availableHeight: C
			});
			let T = await i.getDimensions(a.floating);
...
e(getCssDimensions$1, "getCssDimensions");
function unwrapElement$1(e) {
	return isElement(e) ? e : e.contextElement;
}
e(unwrapElement$1, "unwrapElement");
function getScale$1(e) {
	let t = unwrapElement$1(e);
	if (!isHTMLElement(t)) return createCoords(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = getCssDimensions$1(t), o = (a ? p(n.width) : n.width) / r, s = (a ? p(n.height) : n.height) / i;
	return (!o || !Number.isFinite(o)) && (o = 1), (!s || !Number.isFinite(s)) && (s = 1), {
		x: o,
		y: s
	};
}
e(getScale$1, "getScale");
var ee = /*#__PURE__*/ createCoords(0);
function getVisualOffsets$1(e) {
	let t = getWindow(e);
	return !isWebKit() || !t.visualViewport ? ee : {
		x: t.visualViewport.offsetLeft,
		y: t.visualViewport.offsetTop
	};
}
e(getVisualOffsets$1, "getVisualOffsets");
function shouldAddVisualOffsets$1(e, t, n) {
	return t === void 0 && (t = !1), !!n && t && n === getWindow(e);
}
e(shouldAddVisualOffsets$1, "shouldAddVisualOffsets");
function getBoundingClientRect$1(e, t, n, r) {
	t === void 0 && (t = !1), n === void 0 && (n = !1);
	let i = e.getBoundingClientRect(), a = unwrapElement$1(e), o = createCoords(1);
	t && (r ? isElement(r) && (o = getScale$1(r)) : o = getScale$1(e));
	let s = shouldAddVisualOffsets$1(a, n, r) ? getVisualOffsets$1(a) : createCoords(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a && r) {
		let e = getWindow(a), t = isElement(r) ? getWindow(r) : r, n = e, i = getFrameElement(n);
		for (; i && t !== n;) {
			let e = getScale$1(i), t = i.getBoundingClientRect(), r = getComputedStyle$1(i), a = t.left + (i.clientLeft + parseFloat(r.paddingLeft)) * e.x, o = t.top + (i.clientTop + parseFloat(r.paddingTop)) * e.y;
...
e(getBoundingClientRect$1, "getBoundingClientRect");
function getWindowScrollBarX$1(e, t) {
	let n = getNodeScroll(e).scrollLeft;
	return t ? t.left + n : getBoundingClientRect$1(getDocumentElement(e)).left + n;
}
e(getWindowScrollBarX$1, "getWindowScrollBarX");
function getHTMLOffset$1(e, t) {
	let n = e.getBoundingClientRect();
	return {
		x: n.left + t.scrollLeft - getWindowScrollBarX$1(e, n),
		y: n.top + t.scrollTop
	};
}
e(getHTMLOffset$1, "getHTMLOffset");
function convertOffsetParentRelativeRectToViewportRelativeRect$1(e) {
	...
	if ((d || !a) && ((getNodeName(r) !== "body" || isOverflowElement(o)) && (c = getNodeScroll(r)), d)) {
		let e = getBoundingClientRect$1(r);
		l = getScale$1(r), u.x = e.x + r.clientLeft, u.y = e.y + r.clientTop;
	}
	let f = o && !d && !a ? getHTMLOffset$1(o, c) : createCoords(0);
	return {
		width: n.width * l.x,
		height: n.height * l.y,
...
e(convertOffsetParentRelativeRectToViewportRelativeRect$1, "convertOffsetParentRelativeRectToViewportRelativeRect");
function getClientRects$1(e) {
	return e.getClientRects ? Array.from(e.getClientRects()) : [];
}
e(getClientRects$1, "getClientRects");
function getDocumentRect$1(e) {
	let t = getNodeScroll(e), n = e.ownerDocument.body, r = f(e.scrollWidth, e.clientWidth, n.scrollWidth, n.clientWidth), i = f(e.scrollHeight, e.clientHeight, n.scrollHeight, n.clientHeight), a = -t.scrollLeft + getWindowScrollBarX$1(e), o = -t.scrollTop;
	return getComputedStyle$1(n).direction === "rtl" && (a += f(e.clientWidth, n.clientWidth) - r), {
		width: r,
		height: i,
		x: a,
		y: o
...
e(getDocumentRect$1, "getDocumentRect");
var L = 25;
function getViewportRect$1(e, t, n) {
	n === void 0 && (n = "viewport");
	let r = n === "layoutViewport", i = getWindow(e), a = getDocumentElement(e), o = i.visualViewport, s = a.clientWidth, c = a.clientHeight, l = 0, u = 0;
	if (o) {
		let e = !isWebKit() || t === "fixed";
		r ? e || (l = -o.offsetLeft, u = -o.offsetTop) : (s = o.width, c = o.height, e && (l = o.offsetLeft, u = o.offsetTop));
	}
	if (getWindowScrollBarX$1(a) <= 0) {
...
e(getViewportRect$1, "getViewportRect");
function getInnerBoundingClientRect$1(e, t) {
	let n = getBoundingClientRect$1(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = getScale$1(e);
	return {
...
e(getInnerBoundingClientRect$1, "getInnerBoundingClientRect");
function getClientRectFromClippingAncestor$1(e, t, n) {
	let r;
	if (t === "viewport" || t === "layoutViewport") r = getViewportRect$1(e, n, t);
	else if (t === "document") r = getDocumentRect$1(getDocumentElement(e));
	else if (isElement(t)) r = getInnerBoundingClientRect$1(t, n);
	else {
		let n = getVisualOffsets$1(e);
		r = {
			x: t.x - n.x,
			y: t.y - n.y,
			width: t.width,
...
e(getClientRectFromClippingAncestor$1, "getClientRectFromClippingAncestor");
function getClippingElementAncestors$1(e, t) {
	let n = t.get(e);
	if (n) return n;
	...
	for (; isElement(o) && !isLastTraversableNode(o);) {
		let e = getComputedStyle$1(o), t = isContainingBlock(o), n = i ? i.position : a ? "fixed" : "";
		!t && (n === "fixed" || n === "absolute" && e.position === "static") ? r = r.filter((e) => e !== o) : i = e, o = getParentNode(o);
	}
	return t.set(e, r), r;
}
e(getClippingElementAncestors$1, "getClippingElementAncestors");
function getClippingRect$1(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? isTopLayer(t) ? [] : getClippingElementAncestors$1(t, this._c) : [].concat(n), r], o = getClientRectFromClippingAncestor$1(t, a[0], i), s = o.top, c = o.right, l = o.bottom, u = o.left;
	for (let e = 1; e < a.length; e++) {
		let n = getClientRectFromClippingAncestor$1(t, a[e], i);
...
e(getClippingRect$1, "getClippingRect");
function getDimensions$1(e) {
	let { width: t, height: n } = getCssDimensions$1(e);
	return {
		width: t,
		height: n
	};
}
e(getDimensions$1, "getDimensions");
function getRectRelativeToOffsetParent$1(e, t, n) {
	let r = isHTMLElement(t), i = getDocumentElement(t), a = n === "fixed", o = getBoundingClientRect$1(e, !0, a, t), s = {
		scrollLeft: 0,
		scrollTop: 0
	}, c = createCoords(0);
	if ((r || !a) && ((getNodeName(t) !== "body" || isOverflowElement(i)) && (s = getNodeScroll(t)), r)) {
		let e = getBoundingClientRect$1(t, !0, a, t);
		c.x = e.x + t.clientLeft, c.y = e.y + t.clientTop;
	}
	!r && i && (c.x = getWindowScrollBarX$1(i));
	let l = i && !r && !a ? getHTMLOffset$1(i, s) : createCoords(0);
	return {
...
e(getRectRelativeToOffsetParent$1, "getRectRelativeToOffsetParent");
function isStaticPositioned$1(e) {
	return getComputedStyle$1(e).position === "static";
}
e(isStaticPositioned$1, "isStaticPositioned");
function getTrueOffsetParent$1(e, t) {
...
e(getTrueOffsetParent$1, "getTrueOffsetParent");
function getOffsetParent$1(e, t) {
	let n = getWindow(e);
	if (isTopLayer(e)) return n;
	if (!isHTMLElement(e)) {
		let t = getParentNode(e);
		for (; t && !isLastTraversableNode(t);) {
			if (isElement(t) && !isStaticPositioned$1(t)) return t;
			t = getParentNode(t);
		}
		return n;
	}
	let r = getTrueOffsetParent$1(e, t);
	for (; r && isTableElement(r) && isStaticPositioned$1(r);) r = getTrueOffsetParent$1(r, t);
	return r && isLastTraversableNode(r) && isStaticPositioned$1(r) && !isContainingBlock(r) ? n : r || getContainingBlock(e) || n;
}
e(getOffsetParent$1, "getOffsetParent");
var te = /* @__PURE__ */ e(async function(e) {
	let t = this.getOffsetParent || getOffsetParent$1, n = this.getDimensions, r = await n(e.floating);
	return {
		reference: getRectRelativeToOffsetParent$1(e.reference, await t(e.floating), e.strategy),
		floating: {
			x: 0,
			y: 0,
			width: r.width,
...
function rectsAreEqual$1(e, t) {
	return e.x === t.x && e.y === t.y && e.width === t.width && e.height === t.height;
}
e(rectsAreEqual$1, "rectsAreEqual");
function observeMove$1(e, t, n) {
	let r = null, i, a = getDocumentElement(e);
	function cleanup() {
		var e;
		clearTimeout(i), (e = r) == null || e.disconnect(), r = null;
	}
	function refresh(n, o) {
		n === void 0 && (n = !1), o === void 0 && (o = 1), cleanup();
		let s = e.getBoundingClientRect(), { left: c, top: l, width: u, height: p } = s;
		if (n || t(), !u || !p) return;
		let h = m(l), g = m(a.clientWidth - (c + u)), _ = m(a.clientHeight - (l + p)), v = m(c), y = {
			rootMargin: -h + "px " + -g + "px " + -_ + "px " + -v + "px",
			threshold: f(0, d(1, o)) || 1
		}, b = !0;
		function handleObserve(t) {
			let n = t[0].intersectionRatio;
			if (!rectsAreEqual$1(s, e.getBoundingClientRect())) return refresh();
			if (n !== o) {
				if (!b) return refresh();
				n ? refresh(!1, n) : i = setTimeout(() => {
					refresh(!1, 1e-7);
				}, 1e3);
			}
			b = !1;
		...
		try {
			...
			r = new IntersectionObserver(handleObserve, y);
		}
		r.observe(e);
	}
	let o = getWindow(e), handleResize = () => refresh(n);
	return o.addEventListener("resize", handleResize), refresh(!0), () => {
		o.removeEventListener("resize", handleResize), cleanup();
	};
}
e(observeMove$1, "observeMove");
function autoUpdate$1(e, t, n, r) {
	r === void 0 && (r = {});
	let { ancestorScroll: i = !0, ancestorResize: a = !0, elementResize: o = typeof ResizeObserver == "function", layoutShift: s = typeof IntersectionObserver == "function", animationFrame: c = !1 } = r, l = unwrapElement$1(e), u = i || a ? [...l ? getOverflowAncestors(l) : [], ...t ? getOverflowAncestors(t) : []] : [];
	u.forEach((e) => {
		i && e.addEventListener("scroll", n), a && e.addEventListener("resize", n);
	});
	let d = l && s ? observeMove$1(l, n, a) : null, f = -1, p = null;
	...
	let m, h = c ? getBoundingClientRect$1(e) : null;
	c && frameLoop();
	function frameLoop() {
		let t = getBoundingClientRect$1(e);
		h && !rectsAreEqual$1(h, t) && n(), h = t, m = requestAnimationFrame(frameLoop);
	}
	return n(), () => {
		var e;
		u.forEach((e) => {
...
e(autoUpdate$1, "autoUpdate");
var re = N, ie = P, ae = k, oe = I, se = A, R = D, ce = j, z = F, B = /* @__PURE__ */ e((e, t, n) => {
...
}, "computePosition"), V = typeof document < "u" ? n : function noop() {};
...
function useFloating$1(e) {
	...
	let [g, _] = t.useState(null), [v, y] = t.useState(null), b = t.useCallback((e) => {
		...
		k.current && (e.platform = k.current), B(w.current, T.current, e).then((e) => {
			let t = {
				...e,
...
var arrow$1 = (e) => {
	...
	return {
		...
		fn(t) {
			...
			return n && isRef(n) ? n.current == null ? {} : R({
				element: n.current,
				padding: r
			}).fn(t) : n ? R({
				element: n,
...
//#endregion
//#region ../../node_modules/.pnpm/@floating-ui+react@0.27.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@floating-ui/react/dist/floating-ui.react.mjs
...
var G = "data-floating-ui-focusable", K = "active", q = "selected", le = "ArrowLeft", ue = "ArrowRight", de = "ArrowUp", fe = "ArrowDown", pe = [le, ue], me = [de, fe];
[...pe, ...me];
var he = { ...t }, J = !1, ge = 0, genId = () => "floating-ui-" + Math.random().toString(36).slice(2, 6) + ge++;
function useFloatingId() {
	let [e, n] = t.useState(() => J ? genId() : void 0);
	return S(() => {
		e ?? n(genId());
	}, []), t.useEffect(() => {
		J = !0;
...
var _e = /*#__PURE__*/ t.createContext(null), ve = /*#__PURE__*/ t.createContext(null), useFloatingParentNodeId = () => t.useContext(_e)?.id || null, useFloatingTree = () => t.useContext(ve);
...
var X = /*#__PURE__*/ createAttribute("safe-polygon");
...
function useHover(e, n) {
	...
	let A = t.useCallback(function(e, t, n) {
		...
		if (E.current) {
			...
			e.style.pointerEvents = "", e.removeAttribute(X), E.current = !1;
		}
...
var NOOP = () => {}, Z = /*#__PURE__*/ t.createContext({
	delay: 0,
	initialDelay: 0,
	timeoutMs: 0,
	currentId: null,
	...
	setState: NOOP,
	isInstantPhase: !1
}), useDelayGroupContext = () => t.useContext(Z);
function FloatingDelayGroup(e) {
	...
	}, [o.currentId, o.isInstantPhase]), /*#__PURE__*/ r(Z.Provider, {
		value: t.useMemo(() => ({
			...o,
			setState: s,
			setCurrentId: l
...
function useFloatingRootContext(e) {
	let { open: n = !1, onOpenChange: r, elements: i } = e, a = Y(), o = t.useRef({}), [s] = t.useState(() => createEventEmitter()), c = useFloatingParentNodeId() != null, [l, u] = t.useState(i.reference), d = useEffectEvent$1((e, t, n) => {
...
function useFloating(e) {
	let { elements: n, ...r } = e === void 0 ? {} : e, { nodeId: i } = r, a = useFloatingRootContext({
		...r,
		elements: {
			reference: n?.reference ?? null,
			floating: n?.floating ?? null
		}
	}), o = r.rootContext || a, s = o.elements, [c, l] = t.useState(null), [u, d] = t.useState(null), f = s?.domReference || c, p = t.useRef(null), m = useFloatingTree();
	S(() => {
		f && (p.current = f);
	}, [f]);
	let h = useFloating$1({
	...
	}, [h.refs]), _ = t.useCallback((e) => {
		(isElement(e) || e === null) && (p.current = e, l(e)), (isElement(h.refs.reference.current) || h.refs.reference.current === null || e !== null && !isElement(e)) && h.refs.setReference(e);
	}, [h.refs]), v = t.useMemo(() => ({
		...h.refs,
		setReference: _,
	...
	return S(() => {
		...
		let e = m?.nodesRef.current.find((e) => e.id === i);
		e && (e.context = b);
	}), t.useMemo(() => ({
		...h,
		context: b,
...
function useRole(e, n) {
	n === void 0 && (n = {});
	let { open: r, elements: i, floatingId: a } = e, { enabled: o = !0, role: s = "dialog" } = n, c = Y(), l = i.domReference?.id || c, u = t.useMemo(() => getFloatingFocusElement(i.floating)?.id || a, [i.floating, a]), d = xe.get(s) ?? s, f = useFloatingParentNodeId() != null, p = t.useMemo(() => d === "tooltip" || s === "label" ? { ["aria-" + (s === "label" ? "labelledby" : "describedby")]: r ? u : void 0 } : {
...
var Se = /*#__PURE__*/ createCoords(0);
function getVisualOffsets(e) {
	let t = getWindow(e);
	return !isWebKit() || !t.visualViewport ? Se : {
		x: t.visualViewport.offsetLeft,
		y: t.visualViewport.offsetTop
	};
}
...
function getRectRelativeToOffsetParent(e, t, n) {
	...
	if (r || !r && !a) {
		if ((getNodeName(t) !== "body" || isOverflowElement(i)) && (s = getNodeScroll(t)), r) {
...
var $ = N, we = O, Te = I, Ee = A, computePosition = (e, t, n) => {
...
//#endregion
export { shift as C, getOverflowAncestors as E, H as S, autoUpdate$1 as T, arrow as _, $ as a, inline as b, safePolygon as c, useFloating as d, useFocus as f, useRole as g, useMergeRefs as h, Ee as i, useDelayGroup as l, useInteractions as m, autoUpdate as n, Te as o, useHover as p, computePosition as r, FloatingDelayGroup as s, we as t, useDismiss as u, flip as v, U as w, limitShift as x, W as y };
