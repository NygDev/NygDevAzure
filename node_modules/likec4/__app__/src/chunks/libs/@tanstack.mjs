...
var l = /* @__PURE__ */ new WeakMap(), u = /* @__PURE__ */ new WeakMap(), d = { current: [] }, f = !1, p = 0, m = /* @__PURE__ */ new Set(), h = /* @__PURE__ */ new Map();
function __flush_internals(e) {
	let t = Array.from(e).sort((e, t) => e instanceof g && e.options.deps.includes(t) ? 1 : t instanceof g && t.options.deps.includes(e) ? -1 : 0);
	for (let e of t) {
		if (d.current.includes(e)) continue;
		d.current.push(e), e.recompute();
		let t = u.get(e);
		if (t) for (let e of t) {
			let t = l.get(e);
...
function __flush(e) {
	if (p > 0 && !h.has(e) && h.set(e, e.prevState), m.add(e), !(p > 0) && !f) try {
		for (f = !0; m.size > 0;) {
			let e = Array.from(m);
			m.clear();
			for (let t of e) t.prevState = h.get(t) ?? t.prevState, __notifyListeners(t);
			for (let t of e) {
				let e = l.get(t);
				e && (d.current.push(t), __flush_internals(e));
			}
			for (let t of e) {
				let e = l.get(t);
...
var Store = class {
	...
	registerOnGraph(e = this.options.deps) {
		for (let t of e) if (t instanceof Derived) t.registerOnGraph(), this.registerOnGraph(t.options.deps);
			...
			let e = l.get(t);
			e || (e = /* @__PURE__ */ new Set(), l.set(t, e)), e.add(this);
			let n = u.get(this);
			n || (n = /* @__PURE__ */ new Set(), u.set(this, n)), n.add(t);
		}
	}
...
}, _ = "__TSR_index", v = "popstate", y = "beforeunload";
...
function createBrowserHistory(e) {
	...
	let s = o(), c, l = !1, u = !1, d = !1, f = !1, getLocation = () => s, p, m, flush = () => {
		...
		let e = o(), n = e.state[_] - s.state[_], r = n === 1, i = n === -1, a = !r && !i || l;
		l = !1;
		...
		flush,
		destroy: () => {
			t.history.pushState = n, t.history.replaceState = r, t.removeEventListener(y, onBeforeUnload, { capture: !0 }), t.removeEventListener(v, onPushPopEvent);
		},
		onBlocked: () => {
			c && s !== c && (s = c);
		},
	...
	return t.addEventListener(y, onBeforeUnload, { capture: !0 }), t.addEventListener(v, onPushPopEvent), t.history.pushState = function(...e) {
...
var b = "tsr-scroll-restoration-v1_3", x = !1;
try {
	x = typeof window < "u" && typeof window.sessionStorage == "object";
} catch {}
var throttle = (e, t) => {
	let n;
	return (...r) => {
	...
	set: (e) => (S.state = functionalUpdate(e, S.state) || S.state, window.sessionStorage.setItem(b, JSON.stringify(S.state)))
...
function setupScrollRestoration(e, t) {
	...
	typeof document < "u" && document.addEventListener("scroll", throttle(onScroll, 100), !0), e.subscribe("onRendered", (t) => {
		...
		restoreScroll(b, r, e.options.scrollRestorationBehavior || void 0, e.isScrollRestoring || void 0, e.options.scrollToTopSelectors || void 0), e.isScrollRestoring && S.set((e) => (e[r] = e[r] || {}, e));
	});
}
//#endregion
...
function encode(e, t) {
	let n, r, i, a = "";
	for (n in e) if ((i = e[n]) !== void 0) {
		if (Array.isArray(i)) for (r = 0; r < i.length; r++) a && (a += "&"), a += encodeURIComponent(n) + "=" + encodeURIComponent(i[r]);
...
var w = parseSearchWith(JSON.parse), T = stringifySearchWith(JSON.stringify, JSON.parse);
	...
	constructor(e) {
		this.tempLocationKey = `${Math.round(Math.random() * 1e7)}`, this.resetNextScroll = !0, this.shouldViewTransition = void 0, this.isViewTransitionTypesSupported = void 0, this.subscribers = /* @__PURE__ */ new Set(), this.isScrollRestoring = !1, this.isScrollRestorationSetup = !1, this.startTransition = (e) => e(), this.update = (e) => {
			...
			this.options = {
				...this.options,
				...e
			}, this.isServer = this.options.isServer ?? typeof document > "u", this.pathParamsDecodeCharMap = this.options.pathParamsAllowedCharacters ? new Map(this.options.pathParamsAllowedCharacters.map((e) => [encodeURIComponent(e), e])) : void 0, (!this.basepath || e.basepath && e.basepath !== t.basepath) && (this.basepath = e.basepath === void 0 || e.basepath === "" || e.basepath === "/" ? "/" : `/${trimPath(e.basepath)}`), (!this.history || this.options.history && this.options.history !== this.history) && (this.history = this.options.history ?? (this.isServer ? createMemoryHistory({ initialEntries: [this.basepath || "/"] }) : createBrowserHistory()), this.latestLocation = this.parseLocation()), this.options.routeTree !== this.routeTree && (this.routeTree = this.options.routeTree, this.buildRouteTree()), this.__store || (this.__store = new Store(getInitialRouterState(this.latestLocation), { onUpdate: () => {
				this.__store.state = {
					...this.state,
			...
			let build = (t = {}, n) => {
				...
				let a = this.getMatchedRoutes(r, t), o = build(t, a);
				if (i) {
					let e = this.getMatchedRoutes(i, n);
					o.maskedLocation = build(n, e);
				}
				return o;
			};
			...
			let handleRedirectAndNotFound = (n, r) => {
				...
				if (isRedirect(r) || isNotFound(r)) {
					...
					})), r.routeId || (r.routeId = n.routeId), (a = n.beforeLoadPromise) == null || a.resolve(), (o = n.loaderPromise) == null || o.resolve(), (c = n.loadPromise) == null || c.resolve(), isRedirect(r)) throw s = !0, r = this.resolveRedirect({
						...r,
						_fromLocation: e
					}), r;
			...
			let filter = (e) => {
				...
				let n = (e.preload ? t.options.preloadGcTime ?? this.options.defaultPreloadGcTime : t.options.gcTime ?? this.options.defaultGcTime) ?? 3e5;
				return !(e.status !== "error" && Date.now() - e.updatedAt < n);
			};
			this.clearCache({ filter });
		}, this.loadRouteChunk = (e) => (e._lazyPromise === void 0 && (e._lazyPromise = e.lazyFn ? e.lazyFn().then((t) => {
			let { id: n, ...r } = t.options;
			Object.assign(e.options, r);
		}) : Promise.resolve()), e._componentsPromise === void 0 && (e._componentsPromise = e._lazyPromise.then(() => Promise.all(D.map(async (t) => {
			let n = e.options[t];
			...
			stringifySearch: e.stringifySearch ?? T,
...
var O = "Error preloading route! ☝️", BaseRoute = class {
	constructor(e) {
		if (this.init = (e) => {
			...
			let a = n?.id || i, o = r ? E : joinPaths([this.parentRoute.id === "__root__" ? "" : this.parentRoute.id, a]);
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/CatchBoundary.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-store@0.7.0_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-store/dist/esm/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/routerContext.js
var k = t.createContext(null);
function getRouterContext() {
	return typeof document > "u" ? k : window.__TSR_ROUTER_CONTEXT__ ? window.__TSR_ROUTER_CONTEXT__ : (window.__TSR_ROUTER_CONTEXT__ = k, k);
}
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useRouter.js
function useRouter(e) {
	let n = t.useContext(getRouterContext());
	return e?.warn, n;
}
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useRouterState.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/matchContext.js
var A = t.createContext(void 0), j = t.createContext(void 0);
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useMatch.js
function useMatch(e) {
	let n = t.useContext(e.from ? j : A);
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useLoaderData.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useLoaderDeps.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useParams.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useSearch.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useNavigate.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/route.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/fileRoute.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/not-found.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/SafeFragment.js
function SafeFragment(e) {
	return /* @__PURE__ */ i(r, { children: e.children });
}
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/renderRouteNotFound.js
...
(/* @__PURE__ */ e(((e, t) => {
	var n = {}, r = n.hasOwnProperty, forOwn = (e, t) => {
		...
		if (r && e && isFunction(e.toJSON) && (e = e.toJSON()), !isString(e)) {
			...
			return isBigInt(e) ? r ? JSON.stringify(Number(e)) : e + "n" : isObject(e) ? (y = [], t.wrap = !0, increaseIndentation(), forOwn(e, (e, n) => {
				b = !1, y.push((f ? "" : m) + jsesc(e, t) + ":" + (f ? "" : " ") + jsesc(n, t));
			}), b ? "{}" : "{" + v + y.join("," + v) + v + (f ? "" : h) + "}") : r ? JSON.stringify(e) || "null" : String(e);
		}
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/scroll-restoration.js
function ScrollRestoration() {
	...
	return !e.isScrollRestoring || !e.isServer ? null : /* @__PURE__ */ i(ScriptOnce, {
		children: `(${restoreScroll.toString()})(${JSON.stringify(b)},${JSON.stringify(n)}, undefined, true)`,
		log: !1
	});
}
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Match.js
var M = t.memo(function MatchImpl({ matchId: e }) {
	...
	return /* @__PURE__ */ a(r, { children: [/* @__PURE__ */ i(A.Provider, {
		value: e,
		children: /* @__PURE__ */ i(p, {
			...
			children: /* @__PURE__ */ i(m, {
				...
				children: /* @__PURE__ */ i(h, {
					...
					children: /* @__PURE__ */ i(N, { matchId: e })
				})
			})
		})
...
var N = t.memo(function MatchInnerImpl({ matchId: e }) {
	let n = useRouter(), { match: r, key: a, routeId: o } = useRouterState({
		...
		return e ? /* @__PURE__ */ i(e, {}, a) : /* @__PURE__ */ i(P, {});
	}, [
		a,
		s.options.component,
	...
	return c;
}), P = t.memo(function OutletImpl() {
	let e = useRouter(), n = t.useContext(A), r = useRouterState({ select: (e) => e.matches.find((e) => e.id === n)?.routeId }), a = e.routesById[r], o = useRouterState({ select: (e) => {
	...
	if (!s) return null;
	let c = /* @__PURE__ */ i(M, { matchId: s }), l = e.options.defaultPendingComponent ? /* @__PURE__ */ i(e.options.defaultPendingComponent, {}) : null;
	return n === "__root__" ? /* @__PURE__ */ i(t.Suspense, {
		fallback: l,
		children: c
	}) : c;
}), F = typeof window < "u" ? t.useLayoutEffect : t.useEffect;
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Transitioner.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Matches.js
function Matches() {
	let e = useRouter(), n = e.options.defaultPendingComponent ? /* @__PURE__ */ i(e.options.defaultPendingComponent, {}) : null, r = e.isServer || typeof document < "u" && e.clientSsr ? SafeFragment : t.Suspense, o = /* @__PURE__ */ a(r, {
		fallback: n,
		children: [/* @__PURE__ */ i(Transitioner, {}), /* @__PURE__ */ i(MatchesInner, {})]
	});
	return e.options.InnerWrap ? /* @__PURE__ */ i(e.options.InnerWrap, { children: o }) : o;
}
function MatchesInner() {
	...
	return /* @__PURE__ */ i(A.Provider, {
		...
		children: /* @__PURE__ */ i(CatchBoundary, {
			...
			children: e ? /* @__PURE__ */ i(M, { matchId: e }) : null
		})
	});
}
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/link.js
function useLinkProps(e, n) {
	let r = useRouter(), [i, a] = t.useState(!1), o = t.useRef(!1), c = useForwardedRef(n), { activeProps = () => ({ className: "active" }), inactiveProps = () => ({}), activeOptions: l, to: u, preload: d, preloadDelay: f, hashScrollIntoView: p, replace: m, startTransition: h, resetScroll: g, viewTransition: _, children: v, target: y, disabled: b, style: x, className: S, onClick: C, onFocus: w, onMouseEnter: T, onMouseLeave: E, onTouchStart: D, ignoreBlocker: k, ...A } = e, { params: j, search: M, hash: N, state: P, mask: I, reloadDocument: L, ...R } = A, z = t.useMemo(() => {
		try {
		...
		}) ? !1 : !l?.includeHash || e.location.hash === U.hash;
	} }), q = t.useCallback(() => {
		r.preloadRoute(H).catch((e) => {
			console.warn(e), console.warn(O);
		});
	}, [H, r]);
	if (useIntersectionObserver(c, t.useCallback((e) => {
		e?.isIntersecting && q();
	}, [q]), { rootMargin: "100px" }, { disabled: !!b || W !== "viewport" }), F(() => {
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/router.js
...
//#endregion
//#region ../../node_modules/.pnpm/@tanstack+react-router@1.114.27_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/RouterProvider.js
function RouterContextProvider({ router: e, children: t, ...n }) {
	...
	let r = getRouterContext(), a = /* @__PURE__ */ i(r.Provider, {
		value: e,
		children: t
	});
	return e.options.Wrap ? /* @__PURE__ */ i(e.options.Wrap, { children: a }) : a;
}
...
//#endregion
export { createHashHistory as _, P as a, useNavigate as c, useRouter as d, stripSearchParams as f, createBrowserHistory as g, notFound as h, useMatches as i, useSearch as l, isNotFound as m, createRouter as n, createFileRoute as o, redirect as p, I as r, createRootRouteWithContext as s, RouterProvider as t, useParams as u };
