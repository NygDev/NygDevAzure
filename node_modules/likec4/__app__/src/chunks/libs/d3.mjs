...
function drag_default() {
	...
	function touchstarted(n, r) {
		if (e.call(this, n, r)) for (var a = n.changedTouches, o = t.call(this, n, r), s = a.length, c = 0, l; c < s; ++c) (l = beforestart(this, o, n, r, a[c].identifier, a[c])) && (nopropagation$1(n), l("start", n, a[c]));
	}
	function touchmoved(e) {
		for (var t = e.changedTouches, n = t.length, r = 0, o; r < n; ++r) (o = a[t[r].identifier]) && (noevent_default$1(e), o("drag", e, t[r]));
	}
	...
	function beforestart(e, t, r, s, c, l) {
		...
		if ((h = n.call(e, new DragEvent("beforestart", {
			...
			switch (n) {
				...
				case "drag": f = pointer_default(o || r, t), g = u;
			}
...
function genericArray(e, t) {
	for (var n = t ? t.length : 0, r = e ? Math.min(n, e.length) : 0, a = Array(r), o = Array(n), s = 0; s < r; ++s) a[s] = value_default(e[s], t[s]);
	for (; s < n; ++s) o[s] = t[s];
	return function(e) {
...
var Path = class {
	...
	arcTo(e, t, n, r, a) {
		...
		if (this._x1 === null) this._append`M${this._x1 = e},${this._y1 = t}`;
			...
			if (!(Math.abs(d * c - l * u) > $) || !a) this._append`L${this._x1 = e},${this._y1 = t}`;
			else {
