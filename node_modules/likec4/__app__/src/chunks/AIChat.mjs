...
import { c as t } from "./libs/@tanstack.mjs";
import { C as n, F as r, N as i, O as a, _ as o, b as s, c, j as l, k as u, m as d, t as f, v as p, y as m } from "./hooks.mjs";
import { At as h, C as g, F as _, H as v, Z as ee, _t as te, b as y, et as b, nn as ne, r as re, v as ie, vt as x } from "./libs/@mantine.mjs";
import { C as S, L as C, T as w, y as T } from "./styled-system.mjs";
import { i as ae, m as oe } from "./libs/framer.mjs";
import { a as E, c as D, i as se, n as O, o as k, r as A, s as j, t as M } from "./libs/zod.mjs";
import { a as N, i as ce, n as le, r as ue, t as de } from "./libs/@tanstack-ai.mjs";
import { createContext as fe, use as pe, useEffect as me, useRef as P, useState as he } from "react";
import { c as F } from "react/compiler-runtime";
import { Fragment as I, jsx as L, jsxs as R } from "react/jsx-runtime";
import { RichText as ge, nonNullable as _e, nonexhaustive as ve } from "@likec4/core";
import { ElementShapes as ye } from "@likec4/core/styles";
import { AIAdapter as be } from "likec4:rpc";
...
}, batched = /* @__NO_SIDE_EFFECTS__ */ (e, t) => computedStore(e, t, !0), z = fe(null);
function useChatContext() {
	return _e(pe(z), "useChatContext: ChatProvider is not provided");
}
//#endregion
//#region src/aichat/ChatInput.tsx
function ChatInput() {
	let e = F(22), { sendMessage: t, isLoading: n, messages: r, clear: i, stop: o } = useChatContext(), [s, c] = he(""), l = P(null), t0;
	...
	let d;
	e[7] !== n || e[8] !== t2 || e[9] !== s ? (d = /* @__PURE__ */ L(_, {
		flex: 1,
	...
	let f;
	e[11] !== i || e[12] !== n || e[13] !== r.length ? (f = r.length > 0 && !n && /* @__PURE__ */ L(ee, {
		size: "sm",
		color: "red",
		variant: "light",
		onClick: () => i(),
		children: "Clear"
	}), e[11] = i, e[12] = n, e[13] = r.length, e[14] = f) : f = e[14];
	let p;
	e[15] !== n || e[16] !== o ? (p = n && /* @__PURE__ */ L(x, {
		color: "red",
		variant: "light",
		onClick: () => o(),
		children: /* @__PURE__ */ L(a, {})
	}), e[15] = n, e[16] = o, e[17] = p) : p = e[17];
	let m;
	return e[18] !== d || e[19] !== f || e[20] !== p ? (m = /* @__PURE__ */ R(S, { children: [
		d,
		f,
		p
	] }), e[18] = d, e[19] = f, e[20] = p, e[21] = m) : m = e[21], m;
}
//#endregion
//#region src/aichat/ChatMessage.tsx
function ChatMessages() {
	let e = F(7), { messages: t, error: n } = useChatContext(), r;
	e[0] === t ? r = e[1] : (r = t.map(_temp), e[0] = t, e[1] = r);
	let i;
	e[2] === n ? i = e[3] : (i = n && /* @__PURE__ */ L(y, {
	...
	let a;
	return e[4] !== r || e[5] !== i ? (a = /* @__PURE__ */ R(I, { children: [r, i] }), e[4] = r, e[5] = i, e[6] = a) : a = e[6], a;
}
function _temp(e) {
	return /* @__PURE__ */ L(ChatMessage, { message: e }, e.id);
}
var ChatMessage = (e) => {
	let t = F(4), { message: n } = e, r = n.role, i;
	t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = C({
		color: "text.bright",
		alignSelf: "flex-end",
		paddingInline: "2",
		paddingBlock: "1",
	...
	return t[1] !== n || t[2] !== a ? (o = /* @__PURE__ */ L(de, {
		message: n,
		userClassName: i,
		textPartRenderer: a
	}), t[1] = n, t[2] = a, t[3] = o) : o = t[3], o;
}, UserMessageTextPart = (e) => {
	let t = F(2), { content: n } = e, r;
	return t[0] === n ? r = t[1] : (r = /* @__PURE__ */ L(I, { children: n }), t[0] = n, t[1] = r), r;
}, MarkdownTextPart = (e) => {
	let t = F(4), { content: n } = e, r;
	t[0] === n ? r = t[1] : (r = ge.from({ md: n }), t[0] = n, t[1] = r);
	let i;
	return t[2] === r ? i = t[3] : (i = /* @__PURE__ */ L(c, {
		textScale: .95,
		value: r
	}), t[2] = r, t[3] = i), i;
}, B = /* @__PURE__ */ m(""), V = /* @__PURE__ */ m("closed"), xe = /* @__PURE__ */ batched([B, V], (e, t) => ({
	log: e,
	status: t
}));
...
function SemanticLayoutLog() {
	let e = F(6), { log: t, status: n } = useSemanticLayoutLog();
	if (n === "closed") return null;
	let r = n === "completed", i;
	e[0] === Symbol.for("react.memo_cache_sentinel") ? (i = /* @__PURE__ */ L(re, {
		order: 4,
		children: "Semantic Layout"
	}), e[0] = i) : i = e[0];
	let a = t || "Waiting for response...", o;
	e[1] === a ? o = e[2] : (o = /* @__PURE__ */ L(T, {
		whiteSpace: "pre-wrap",
		children: a
	}), e[1] = a, e[2] = o);
	let s;
	return e[3] !== r || e[4] !== o ? (s = /* @__PURE__ */ L(g, {
		size: "xl",
		opened: !0,
...
var H = j({
	id: D().meta({ description: "Node ID" }),
	title: D(),
	shape: M(ye),
	color: D().meta({ description: "Node color, from theme or custom" }),
	icon: D().nullish(),
	parentId: D().nullish().meta({ description: "Parent node ID (if node is nested)" }),
	children: O(D()).nullish().meta({ description: "Nested node IDs (if node is compound)" }),
	x: k(),
	y: k(),
	width: k(),
	height: k(),
	modelFqn: D().nullish().meta({ description: "Model element FQN (if node has reference)" })
}), Se = N({
	name: "read_ui",
	description: "Read current UI state. Use arguments to include additional data.",
	needsApproval: !1,
	inputSchema: j({
		selectedNode: A().default(!1).meta({ description: "Include selected node (if any)" }),
		nodes: A().default(!1).meta({ description: "Include all nodes from the view" })
	}),
	outputSchema: j({
		projectId: D(),
		editMode: A().meta({ description: "Whether the UI is in edit mode" }),
		view: j({
			id: D(),
			title: D(),
			type: M([
		...
		nodes: O(H).nullish(),
		selectedNode: H.nullish()
	})
}), Ce = j({
	type: E("focus"),
	elementId: D().meta({ description: "Element ID (FQN)" })
}).meta({ description: "Focus UI on an element by its FQN" }), we = j({ type: E("fitview") }).meta({ description: "Zoom out to fit all elements in the viewport, and clear any selection/focus" }), Te = N({
	name: "update_ui",
	description: "Update UI state by executing a command.",
	needsApproval: !1,
	inputSchema: j({ command: se("type", [Ce, we]) }),
	outputSchema: j({})
}), Ee = N({
	name: "navigate_to",
	description: "Navigates UI to another view",
	needsApproval: !1,
	inputSchema: j({ viewId: D().meta({ description: "View ID" }) }),
	outputSchema: j({})
...
}, De = /* @__PURE__ */ e((e) => Object.prototype.toString.call(e).slice(8, -1), "getType"), isUndefined = (e) => e === void 0, isNull = (e) => e === null, U = /* @__PURE__ */ e((e) => typeof e != "object" || !e || e === Object.prototype ? !1 : Object.getPrototypeOf(e) === null || Object.getPrototypeOf(e) === Object.prototype, "isPlainObject"), isEmptyObject = (e) => U(e) && Object.keys(e).length === 0, W = /* @__PURE__ */ e((e) => Array.isArray(e), "isArray"), isString = (e) => typeof e == "string", isNumber = (e) => typeof e == "number" && !isNaN(e), isBoolean = (e) => typeof e == "boolean", isRegExp = (e) => e instanceof RegExp, isMap = (e) => e instanceof Map, isSet = (e) => e instanceof Set, isSymbol = (e) => De(e) === "Symbol", isDate = (e) => e instanceof Date && !isNaN(e.valueOf()), isError = (e) => e instanceof Error, isNaNValue = (e) => typeof e == "number" && isNaN(e), isPrimitive = (e) => isBoolean(e) || isNull(e) || isUndefined(e) || isNumber(e) || isString(e) || isSymbol(e), isBigint = (e) => typeof e == "bigint", isInfinite = (e) => e === Infinity || e === -Infinity, isTypedArray = (e) => ArrayBuffer.isView(e) && !(e instanceof DataView), isURL = (e) => e instanceof URL, escapeKey = (e) => e.replace(/\\/g, "\\\\").replace(/\./g, "\\."), stringifyPath = (e) => e.map(String).map(escapeKey).join("."), parsePath = (e, t) => {
	let n = [], r = "";
...
var K = compositeTransformation((e, t) => isSymbol(e) ? !!t.symbolRegistry.getIdentifier(e) : !1, (e, t) => ["symbol", t.symbolRegistry.getIdentifier(e)], (e) => e.description, (e, t, n) => {
...
var Y = compositeTransformation(isInstanceOfRegisteredClass, (e, t) => ["class", t.classRegistry.getIdentifier(e.constructor)], (e, t) => {
	...
	let n = findArr(Oe, (n) => n.isApplicable(e, t));
	if (n) return {
		value: n.transform(e, t),
		type: n.annotation(e, t)
	};
	let r = findArr(G, (n) => n.isApplicable(e, t));
	if (r) return {
...
var untransformValue = (e, t, n) => {
	if (W(t)) switch (t[0]) {
		case "symbol": return K.untransform(e, t, n);
...
var getDeep = (e, t) => {
	...
	let i = t[t.length - 1];
	if (W(r) ? r[+i] = n(r[+i]) : U(r) && (r[i] = n(r[i])), isSet(r)) {
...
var isDeep = (e, t) => U(e) || W(e) || isMap(e) || isSet(e) || isError(e) || isInstanceOfRegisteredClass(e, t);
...
var walker = (e, t, n, r, i = [], a = [], o = /* @__PURE__ */ new Map()) => {
	...
	let c = transformValue(e, n), l = c?.value ?? e, u = W(l) ? [] : {}, d = {};
	forEach(l, (s, c) => {
		...
		u[c] = l.transformedValue, W(l.annotations) ? d[escapeKey(c)] = l.annotations : U(l.annotations) && forEach(l.annotations, (e, t) => {
			d[escapeKey(c) + "." + t] = e;
		});
	});
...
var ke = SuperJSON.stringify, Ae = SuperJSON.parse;
...
function useChatTools() {
	let e = F(11), { id: n } = f(), a = t(), o = d(), s;
	if (e[0] !== o || e[1] !== a || e[2] !== n) {
		let t1;
		e[4] === a ? t1 = e[5] : (t1 = (e) => {
			let { viewId: t } = e;
			return a({
		...
		let t2;
		e[6] !== o || e[7] !== n ? (t2 = (e) => {
			let { view: t, focusedNode: a, xynodes: s, xystore: c, toggledFeatures: u, features: d } = o.getContext(), f = u.enableReadOnly ?? d.enableReadOnly, p = mapToNodeData(c.getState()), m = e.nodes === !0 && l(s, p) || void 0, h = e.selectedNode === !0 && r(s, i((e) => !!e.selected || e.id === a), (e) => e ? p(e) : void 0);
			return {
				projectId: n,
				editMode: !f,
				view: {
		...
		}, e[6] = o, e[7] = n, e[8] = t2) : t2 = e[8];
		let t3;
		e[9] === o ? t3 = e[10] : (t3 = (e) => {
			let { command: t } = e;
			bb50: switch (t.type) {
				case "focus":
					o.focusOnElement(t.elementId);
					break bb50;
				case "fitview":
					o.fitDiagram();
					break bb50;
			...
			return {};
		}, e[9] = o, e[10] = t3), s = ue(Ee.client(t1), Se.client(t2), Te.client(t3)), e[0] = o, e[1] = a, e[2] = n, e[3] = s;
	} else s = e[3];
	return s;
}
var Q = {
	...
	write(e) {
		try {
			...
			sessionStorage.setItem(this.key, ke(e));
		} catch {}
	}
};
function useChat(e) {
	...
	return t[4] === o.messages ? (t3 = t[5], s = t[6]) : (t3 = () => {
		Q.write(o.messages);
	}, s = [o.messages], t[4] = o.messages, t[5] = t3, t[6] = s), me(t3, s), o;
}
//#endregion
...
function AIChatComponent() {
	...
	return /* @__PURE__ */ R(I, { children: [/* @__PURE__ */ R(oe, { children: [!t && /* @__PURE__ */ L(v, {
		w: 300,
		pos: "fixed",
		className: C({
			rounded: "md",
		...
		onPositionChange,
		children: /* @__PURE__ */ L(AIChatWindowContent, { onClose: () => n(!0) })
	}), t && /* @__PURE__ */ L(ae.div, {
		initial: {
			opacity: .1,
			translateX: "10%"
		...
		children: /* @__PURE__ */ L(ie, {
			...
			children: /* @__PURE__ */ L(x, {
				...
				variant: "gradient",
				onClick: () => n(!1),
				children: /* @__PURE__ */ L(u, { stroke: 1.5 })
			})
		})
	}, "collapsed")] }), /* @__PURE__ */ L(SemanticLayoutLog, {})] });
}
function AIChatWindowContent(e) {
	let t = F(15), { onClose: r } = e, i = P(null), t1;
	...
	t[1] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => {
		a();
	}, t[1] = t2) : t2 = t[1], n(t2, 100);
	let o;
	t[2] === Symbol.for("react.memo_cache_sentinel") ? (o = { onChunk: a }, t[2] = o) : o = t[2];
	let s = useChat(o), c;
	t[3] === Symbol.for("react.memo_cache_sentinel") ? (c = /* @__PURE__ */ R(S, { children: [/* @__PURE__ */ L(T, {
	...
	let l;
	t[4] === r ? l = t[5] : (l = /* @__PURE__ */ R(S, {
		cursor: "move",
		justify: "space-between",
		children: [c, /* @__PURE__ */ L(te, {
			size: "sm",
			onClick: (e) => {
				e.stopPropagation(), r();
			}
	...
	let u;
	t[6] === Symbol.for("react.memo_cache_sentinel") ? (u = { content: C({ display: "contents" }) }, t[6] = u) : u = t[6];
	let d;
	t[7] === Symbol.for("react.memo_cache_sentinel") ? (d = /* @__PURE__ */ L(ChatMessages, {}), t[7] = d) : d = t[7];
	let f, p;
	t[8] === Symbol.for("react.memo_cache_sentinel") ? (f = /* @__PURE__ */ L(h, {
		scrollbars: "y",
		w: "100%",
		flex: 1,
		mih: 250,
		mah: 350,
		classNames: u,
		children: /* @__PURE__ */ R(w, { children: [d, /* @__PURE__ */ L("div", {
			ref: i,
			style: { height: 2 }
		})] })
	}), p = /* @__PURE__ */ L(ChatInput, {}), t[8] = f, t[9] = p) : (f = t[8], p = t[9]);
	let m;
	t[10] === l ? m = t[11] : (m = /* @__PURE__ */ R(w, {
		w: "100%",
		children: [
			l,
			f,
	...
	let g;
	return t[12] !== s || t[13] !== m ? (g = /* @__PURE__ */ L(z, {
		value: s,
		children: m
	}), t[12] = s, t[13] = m, t[14] = g) : g = t[14], g;
}
//#endregion
