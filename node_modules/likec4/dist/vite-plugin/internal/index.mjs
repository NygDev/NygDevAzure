...
//#endregion
//#region ../../node_modules/.pnpm/remeda@2.45.0/node_modules/remeda/dist/mapValues.js
function t(...t) {
	return t$1(n, t);
}
function n(e, t) {
...
function createHooksForModel($atom) {
	...
	function useLikeC4View(viewId) {
		const $view = useMemo(() => /* @__PURE__ */ computed($likec4model, (model) => model.findView(viewId)?.$layouted ?? null), [viewId]);
