...
import { $ as cancellation_d_exports, A as DiagnosticInfo, B as DefaultNameProvider, C as CodeLensParams, D as RequestType, E as NotificationType, F as DefaultScopeProvider, G as AstNodeDescription, H as AsyncDisposable, I as Scope, J as ReferenceInfo, K as CstNode, L as JSDocDocumentationProvider, M as DefaultValueConverter, N as ValueType, O as DefaultDocumentValidator, P as MaybePromise, Q as PrecomputedScopes, R as DefaultIndexManager, S as CodeActionParams, T as DocumentSymbolParams, U as Disposable$1, V as WorkspaceCache, W as AstNode, X as LangiumDocument, Y as DefaultLangiumDocuments, Z as LangiumDocumentFactory, _ as CodeLensProvider, _t as TextEdit, a as LangiumServices, at as CodeLens, b as DefaultWorkspaceManager, bt as ast_d_exports, c as AbstractSemanticTokenProvider, ct as Diagnostic, d as AbstractFormatter, dt as DocumentSymbol, et as CancellationToken$1, f as FormattingRegion, ft as FormattingOptions, g as DefaultDocumentHighlightProvider, gt as SymbolKind, h as DocumentLinkProvider, ht as Range, i as NextFeature, it as CodeAction, j as DefaultScopeComputation, k as ValidationOptions, l as SemanticTokenAcceptor, lt as DocumentHighlight, m as NodeKindProvider, mt as Location, n as CompletionContext, nt as FileSystemNode, o as LangiumSharedServices, ot as Command, p as DocumentSymbolProvider, pt as Hover, q as Reference, r as DefaultCompletionProvider, rt as FileSystemProvider, s as DefaultWorkspaceSymbolProvider, st as CompletionItemKind, t as CompletionAcceptor, tt as Stream, u as AstNodeHoverProvider, ut as DocumentLink, v as CodeActionProvider, vt as WorkspaceFolder, w as DocumentLinkParams, x as BuildOptions, xt as URI, y as index_d_exports, yt as Keyword, z as ReferenceDescription } from "./libs/langium.mjs";
import { t as $keywords } from "./libs/@ts-graphviz/common.mjs";
import "./libs/unstorage.mjs";
...
import { AnyTypes, Builder, BuilderMode, BuilderSpecification, Types } from "@likec4/core/builder";
...
//#region ../../node_modules/.pnpm/@logtape+logtape@2.3.4/node_modules/@logtape/logtape/dist/level.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@logtape+logtape@2.3.4/node_modules/@logtape/logtape/dist/record.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@logtape+logtape@2.3.4/node_modules/@logtape/logtape/dist/logger.d.ts
/**
...
//#endregion
//#region ../layouts/dist/chunks/types.d.mts
/**
...
//#endregion
//#region ../language-server/dist/chunks/protocol.d.mts
/**
...
//#endregion
//#region ../layouts/dist/chunks/GraphvizLayoter.d.mts
...
declare class GraphvizLayouter implements Disposable {
  ...
  aiLayout<A extends AnyAux>({ view, styles }: LayoutTaskParams<A>, hints: AILayoutHints): Promise<LayoutResult<A>>;
...
//#endregion
//#region ../language-server/dist/chunks/module.d.mts
...
interface AbstractStep extends AstNode {
...
interface AltSteps extends AstNode {
...
interface FinallyBlock extends AstNode {
  readonly $container: DynamicViewBody | StepsBlock;
...
interface FqnRef$2 extends AstNode {
...
interface IconColorProperty extends AstNode {
...
interface IconPositionProperty extends AstNode {
  readonly $container: CustomElementProperties | DeploymentViewRuleStyle | ElementStyleProperty | GlobalStyle | ViewRuleStyle;
...
interface IconSizeProperty extends AstNode {
  readonly $container: CustomElementProperties | DeploymentViewRuleStyle | ElementStyleProperty | GlobalStyle | ViewRuleStyle;
...
interface StepsBlock extends AstNode {
...
interface ViewOrderProperty extends AstNode {
...
declare class MergedSpecification {
   ...
   */
  toDeploymentRelation: ({ astPath: _astPath, source, target, kind, links, id, tags, isBidirectional, ...model }: ParsedAstDeploymentRelation) => c4.DeploymentRelationship | null;
}
//#endregion
...
declare const DocumentParserFromMixins: {
  new (...args: any[]): {
    ...
    parseSteps(nodes: StepStatement[]): ProjectId$1[];
    parseStepStatement(node: StepStatement): ProjectId$1;
    parseStepSeries(node: StepSeries): ProjectId$1;
    recursiveParseStepSeries(node: StepSeries, callstack?: Array<[source: ProjectId$1, target: ProjectId$1]>): ProjectId$1[];
    parseStep(node: Step): ProjectId$1;
    parseAbstractDynamicStep(astnode: AbstractStep): import("type-fest").Writable<import("type-fest").Except<ProjectId$1, "source", {
      requireExactProps: true;
    }>>;
    parseModelElementRef(node: ElementRef, errorMessage: string): ProjectId$1;
    parseDynamicStepEndpoint(node: ElementRef, endpoint: "source" | "target"): ProjectId$1;
    parseSubflowStep(node: SubflowStep): ProjectId$1 | ProjectId$1 | ProjectId$1 | ProjectId$1;
    parseTryStep(node: TryStep): ProjectId$1;
    parseAltSteps(node: AltSteps): ProjectId$1;
    ...
    parseCustomRelationProperties(custom: CustomRelationProperties | undefined): import("type-fest").Except<ProjectId$1["customRelation"], "expr">;
    ...
    tryMap<N extends AstNode, T>(level: "base" | "model" | "deployment" | "fqnref" | "relation" | "views" | "globals" | "imports" | "specification", iterable: ReadonlyArray<N>, fn: (node: N, index: number) => T | undefined): T[];
...
interface LikeC4LanguageServices {
   ...
   */
  projects(): NonEmptyArray$1<LikeC4ProjectData>;
  /**
   * Returns project by ID, returns default project if no ID is specified
   */
  project(projectId?: ProjectId$1): LikeC4ProjectData;
  /**
...
//#endregion
//#region ../language-services/dist/chunks/options.d.mts
...
declare class LikeC4 {
   ...
   */
  parsedModel(project?: string | undefined): Promise<LikeC4Model.Parsed>;
  /**
   ...
   * ```
   */
  toBuilder(mode?: BuilderMode, project?: string | undefined): Promise<Builder<AnyTypes>>;
  /**
   ...
   * ```
   */
  toTypedBuilder<const Spec extends BuilderSpecification>(options: {
   ...
   */
  toDSL(project?: string | undefined): Promise<string>;
...
//#endregion
//#region ../language-services/dist/node/index.d.mts
/**
 * Options for {@link writeDSL}.
 */
interface WriteDSLOptions {
 ...
 * ```
 */
declare function writeDSL(likec4: LikeC4, targetDir: string, options?: WriteDSLOptions): Promise<string>;
//#endregion
export { LikeC4LanguageServices as i, writeDSL as n, LikeC4 as r, WriteDSLOptions as t };