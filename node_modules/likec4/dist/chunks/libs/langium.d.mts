import { i as __name, r as __exportAll } from "../rolldown-runtime.mjs";
import { t as IToken$1 } from "./@chevrotain/types.mjs";
import { CustomPatternMatcherFunc, DSLMethodOpts, EmbeddedActionsParser, ILexerErrorMessageProvider, ILexingError, IMultiModeLexerDefinition, IOrAlt, IParserConfig, IParserErrorMessageProvider, IRecognitionException, IRuleConfig, IToken, Lexer, TokenPattern, TokenType, TokenTypeDictionary, TokenVocabulary } from "chevrotain";
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/dependency-injection.d.ts
/******************************************************************************
 ...
 * dependencies.
 */
type Module<I, T = I> = { [K in keyof T]: Module<I, T[K]> | ((injector: I) => T[K]); };
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/languages/grammar-config.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-uri@3.1.0/node_modules/vscode-uri/lib/umd/uri.d.ts
/**
 ...
 * ```
 */
declare class URI$1 implements UriComponents {
  static isUri(thing: any): thing is URI$1;
  /**
   ...
   */
  static parse(value: string, _strict?: boolean): URI$1;
  /**
  ...
  static revive(data: UriComponents | URI$1): URI$1;
  static revive(data: UriComponents | URI$1 | undefined): URI$1 | undefined;
  static revive(data: UriComponents | URI$1 | null): URI$1 | null;
  static revive(data: UriComponents | URI$1 | undefined | null): URI$1 | undefined | null;
}
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-uri@3.1.0/node_modules/vscode-uri/lib/umd/utils.d.ts
declare namespace Utils {
   ...
   */
  function joinPath(uri: URI$1, ...paths: string[]): URI$1;
  /**
   ...
   */
  function resolvePath(uri: URI$1, ...paths: string[]): URI$1;
  /**
   ...
   */
  function dirname(uri: URI$1): URI$1;
  /**
   ...
   */
  function basename(uri: URI$1): string;
  /**
   ...
   */
  function extname(uri: URI$1): string;
}
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/uri-utils.d.ts
declare namespace UriUtils {
  ...
  function equals(a?: URI$1 | string, b?: URI$1 | string): boolean;
  function relative(from: URI$1 | string, to: URI$1 | string): string;
  function normalize(uri: URI$1 | string): string;
}
declare namespace ast_d_exports {
  export { AbstractElement, AbstractRule, AbstractType, Action, Alternatives, ArrayLiteral, ArrayType, Assignment, BooleanLiteral, CharacterRange, Condition, Conjunction, CrossReference, Disjunction, EndOfFile, FeatureName, Grammar, GrammarImport, Group, InferredType, Interface, Keyword, LangiumGrammarAstReflection, LangiumGrammarAstType, LangiumGrammarKeywordNames, LangiumGrammarTerminalNames, LangiumGrammarTerminals, LangiumGrammarTokenNames, NamedArgument, NegatedToken, Negation, NumberLiteral, Parameter, ParameterReference, ParserRule, PrimitiveType, ReferenceType, RegexToken, ReturnType$1 as ReturnType, RuleCall, SimpleType, StringLiteral, TerminalAlternatives, TerminalGroup, TerminalRule, TerminalRuleCall, Type, TypeAttribute, TypeDefinition, UnionType, UnorderedGroup, UntilToken, ValueLiteral, Wildcard, isAbstractElement, isAbstractRule, isAbstractType, isAction, isAlternatives, isArrayLiteral, isArrayType, isAssignment, isBooleanLiteral, isCharacterRange, isCondition, isConjunction, isCrossReference, isDisjunction, isEndOfFile, isFeatureName, isGrammar, isGrammarImport, isGroup, isInferredType, isInterface, isKeyword, isNamedArgument, isNegatedToken, isNegation, isNumberLiteral, isParameter, isParameterReference, isParserRule, isPrimitiveType, isReferenceType, isRegexToken, isReturnType, isRuleCall, isSimpleType, isStringLiteral, isTerminalAlternatives, isTerminalGroup, isTerminalRule, isTerminalRuleCall, isType, isTypeAttribute, isTypeDefinition, isUnionType, isUnorderedGroup, isUntilToken, isValueLiteral, isWildcard, reflection };
}
...
type LangiumGrammarTerminalNames = keyof typeof LangiumGrammarTerminals;
type LangiumGrammarKeywordNames = "!" | "&" | "(" | ")" | "*" | "+" | "+=" | "," | "->" | "." | ".." | ":" | ";" | "<" | "=" | "=>" | ">" | "?" | "?!" | "?<!" | "?<=" | "?=" | "@" | "Date" | "EOF" | "[" | "]" | "bigint" | "boolean" | "current" | "entry" | "extends" | "false" | "fragment" | "grammar" | "hidden" | "import" | "infer" | "infers" | "interface" | "number" | "returns" | "string" | "terminal" | "true" | "type" | "with" | "{" | "|" | "}";
type LangiumGrammarTokenNames = LangiumGrammarTerminalNames | LangiumGrammarKeywordNames;
...
declare function isFeatureName(item: unknown): item is FeatureName;
type PrimitiveType = 'Date' | 'bigint' | 'boolean' | 'number' | 'string';
declare function isPrimitiveType(item: unknown): item is PrimitiveType;
...
declare function isReturnType(item: unknown): item is ReturnType$1;
...
declare const Alternatives = "Alternatives";
...
declare const EndOfFile = "EndOfFile";
...
interface NegatedToken extends AbstractElement {
  readonly $type: 'NegatedToken';
  terminal: AbstractElement;
}
declare const NegatedToken = "NegatedToken";
declare function isNegatedToken(item: unknown): item is NegatedToken;
interface RegexToken extends AbstractElement {
  readonly $type: 'RegexToken';
  regex: string;
}
declare const RegexToken = "RegexToken";
...
interface TerminalAlternatives extends AbstractElement {
  readonly $type: 'TerminalAlternatives';
  elements: Array<AbstractElement>;
}
declare const TerminalAlternatives = "TerminalAlternatives";
declare function isTerminalAlternatives(item: unknown): item is TerminalAlternatives;
interface TerminalGroup extends AbstractElement {
  readonly $type: 'TerminalGroup';
  elements: Array<AbstractElement>;
}
declare const TerminalGroup = "TerminalGroup";
declare function isTerminalGroup(item: unknown): item is TerminalGroup;
interface TerminalRuleCall extends AbstractElement {
  readonly $type: 'TerminalRuleCall';
  rule: Reference<TerminalRule>;
}
declare const TerminalRuleCall = "TerminalRuleCall";
...
declare const UnorderedGroup = "UnorderedGroup";
declare function isUnorderedGroup(item: unknown): item is UnorderedGroup;
interface UntilToken extends AbstractElement {
  readonly $type: 'UntilToken';
  terminal: AbstractElement;
}
declare const UntilToken = "UntilToken";
declare function isUntilToken(item: unknown): item is UntilToken;
interface Wildcard extends AbstractElement {
  readonly $type: 'Wildcard';
}
declare const Wildcard = "Wildcard";
...
declare class LangiumGrammarAstReflection extends AbstractAstReflection {
  getAllTypes(): string[];
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-textdocument@1.0.11/node_modules/vscode-languageserver-textdocument/lib/esm/main.d.ts
/**
...
declare namespace TextDocument {
   ...
   */
  function create(uri: DocumentUri$1, languageId: string, version: number, content: string): TextDocument;
  /**
  ...
  function applyEdits(document: TextDocument, edits: TextEdit$1[]): string;
}
//#endregion
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/file-system-provider.d.ts
interface FileSystemNode {
  readonly isFile: boolean;
  readonly isDirectory: boolean;
  readonly uri: URI$1;
}
type FileSystemFilter = (node: FileSystemNode) => boolean;
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/stream.d.ts
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
 ...
 */
interface TreeIterator<T> extends IterableIterator<T> {
  /**
 ...
 */
interface TreeStream<T> extends Stream<T> {
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/token-builder.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/lexer.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/langium-parser.d.ts
...
declare abstract class AbstractLangiumParser implements BaseParser {
  protected readonly lexer: Lexer$1;
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/service-registry.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/collections.d.ts
/**
...
interface AbstractCancellationTokenSource extends Disposable$1 {
...
declare namespace cancellation_d_exports {
  export { AbstractCancellationTokenSource, CancellationToken, CancellationTokenSource };
}
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/documents.d.ts
/**
...
interface LangiumDocumentFactory {
   ...
   */
  fromTextDocument<T extends AstNode = AstNode>(textDocument: TextDocument, uri: URI$1 | undefined, cancellationToken: CancellationToken): Promise<LangiumDocument<T>>;
  /**
   ...
   */
  fromString<T extends AstNode = AstNode>(text: string, uri: URI$1, cancellationToken: CancellationToken): Promise<LangiumDocument<T>>;
  /**
   ...
   */
  fromUri<T extends AstNode = AstNode>(uri: URI$1, cancellationToken?: CancellationToken): Promise<LangiumDocument<T>>;
  /**
...
declare class DefaultLangiumDocumentFactory implements LangiumDocumentFactory {
  ...
  fromString<T extends AstNode = AstNode>(text: string, uri: URI$1, cancellationToken: CancellationToken): Promise<LangiumDocument<T>>;
  fromModel<T extends AstNode = AstNode>(model: T, uri: URI$1): LangiumDocument<T>;
  protected create<T extends AstNode = AstNode>(uri: URI$1, content: string | TextDocument | {
    $model: T;
  }, options?: ParserOptions): LangiumDocument<T>;
  protected createAsync<T extends AstNode = AstNode>(uri: URI$1, content: string | TextDocument, cancelToken: CancellationToken): Promise<LangiumDocument<T>>;
  /**
   ...
   */
  protected createLangiumDocument<T extends AstNode = AstNode>(parseResult: ParseResult<T>, uri: URI$1, textDocument?: TextDocument, text?: string): LangiumDocument<T>;
  ...
  protected parse<T extends AstNode>(uri: URI$1, text: string, options?: ParserOptions): ParseResult<T>;
  protected parseAsync<T extends AstNode>(uri: URI$1, text: string, cancellationToken: CancellationToken): Promise<ParseResult<T>>;
  protected createTextDocumentGetter(uri: URI$1, text?: string): () => TextDocument;
}
/**
...
interface LangiumDocuments {
   ...
   */
  getOrCreateDocument(uri: URI$1, cancellationToken?: CancellationToken): Promise<LangiumDocument>;
  /**
   ...
   * @throws an error if a document with the same URI is already present.
   */
  createDocument(uri: URI$1, text: string, cancellationToken: CancellationToken): Promise<LangiumDocument>;
  /**
...
declare namespace syntax_tree_d_exports {
  export { AbstractAstReflection, AstNode, AstNodeDescription, AstNodeTypesWithCrossReferences, AstReflection, AstTypeList, CompositeCstNode, CrossReferencesOfAstNodeType, CstNode, GenericAstNode, LeafCstNode, LinkingError, Mutable, Properties, PropertyType, Reference, ReferenceInfo, ResolvedReference, RootCstNode, TypeMetaData, TypeProperty, isAstNode, isAstNodeDescription, isCompositeCstNode, isLeafCstNode, isLinkingError, isReference, isRootCstNode };
}
/**
 ...
 */
type CrossReferencesOfAstNodeType<N extends AstNode> = ExtractKeysOfValueType<N, Reference | Reference[]>;
/**
 * Represents the enumeration-like type, that lists all AstNode types of your grammar.
 */
type AstTypeList<T> = Record<keyof T, AstNode>;
/**
 ...
 */
type AstNodeTypesWithCrossReferences<A extends AstTypeList<A>> = { [T in keyof A]-?: CrossReferencesOfAstNodeType<A[T]> extends never ? never : A[T]; }[keyof A];
type Mutable<T> = { -readonly [P in keyof T]: T[P]; };
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/documentation/comment-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/disposable.d.ts
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/caching.d.ts
 ...
 */
declare class DocumentCache<K, V> extends ContextCache<URI$1 | string, K, V, string> {
  /**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/references/name-provider.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/ast-node-locator.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/ast-descriptions.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/index-manager.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/documentation/jsdoc.d.ts
interface JSDocComment extends JSDocValue {
  readonly elements: JSDocElement[];
  getTag(name: string): JSDocTag | undefined;
  getTags(name: string): JSDocTag[];
}
type JSDocElement = JSDocParagraph | JSDocTag;
type JSDocInline = JSDocTag | JSDocLine;
...
interface JSDocParagraph extends JSDocValue {
  readonly inlines: JSDocInline[];
}
interface JSDocLine extends JSDocValue {
  readonly text: string;
}
interface JSDocTag extends JSDocValue {
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/documentation/documentation-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/languages/language-meta-data.d.ts
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/references/scope.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/references/scope-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/references/linker.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/serializer/hydrator.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/promise-utils.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/async-parser.d.ts
/**
...
type WorkerMessagePost = (message: unknown) => void;
type WorkerMessageCallback = (cb: (message: unknown) => void) => void;
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/value-converter.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/references/references.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/references/scope-computation.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/serializer/json-serializer.d.ts
 ...
 */
interface AstNodeWithTextRegion extends AstNode {
  $sourceText?: string;
 ...
 */
interface AstNodeWithComment extends AstNode {
  $comment?: string;
}
 ...
 */
interface AstNodeRegionWithAssignments extends DocumentSegment {
  /**
...
declare class DefaultJsonSerializer implements JsonSerializer {
  ...
  protected getRefNode(root: AstNode, uri: string, uriConverter?: (uri: string) => URI$1): AstNode | string;
}
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/validation/validation-registry.d.ts
 ...
 */
type ValidationChecks<T> = { [K in keyof T]?: T[K] extends AstNode ? ValidationCheck<T[K]> | Array<ValidationCheck<T[K]>> : never; } & {
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/validation/document-validator.d.ts
...
declare function getDiagnosticRange<N extends AstNode>(info: DiagnosticInfo<N, string>): Range;
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/messages.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.implementation.d.ts
/**
 * @since 3.6.0
 */
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.typeDefinition.d.ts
/**
 * Since 3.6.0
 */
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.workspaceFolder.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.configuration.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.colorProvider.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.foldingRange.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.declaration.d.ts
/**
 * @since 3.14.0
 */
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.selectionRange.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.callHierarchy.d.ts
/**
 * @since 3.16.0
 */
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.semanticTokens.d.ts
/**
 * @since 3.16.0
 */
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.showDocument.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.linkedEditingRange.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.fileOperations.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.moniker.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.typeHierarchy.d.ts
/**
 * @since 3.17.0
 */
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.inlineValue.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.inlayHint.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.diagnostic.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.notebook.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.inlineCompletion.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/configuration.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/document-builder.d.ts
...
interface DocumentBuilder {
   ...
   */
  update(changed: URI$1[], deleted: URI$1[], cancelToken?: CancellationToken): Promise<void>;
  /**
   ...
   * @throws `OperationCancelled` if cancellation has been requested before the state has been reached
   */
  waitUntil(state: DocumentState, uri?: URI$1, cancelToken?: CancellationToken): Promise<URI$1 | undefined>;
}
...
declare class DefaultDocumentBuilder implements DocumentBuilder {
  ...
  build<T extends AstNode>(documents: Array<LangiumDocument<T>>, options?: BuildOptions, cancelToken?: CancellationToken): Promise<void>;
  update(changed: URI$1[], deleted: URI$1[], cancelToken?: CancellationToken): Promise<void>;
  protected emitUpdate(changed: URI$1[], deleted: URI$1[]): Promise<void>;
  /**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/workspace-lock.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/workspace/workspace-manager.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/services.d.ts
/**
 ...
 */
type DeepPartial<T> = T[keyof T] extends Function ? T : { [P in keyof T]?: DeepPartial<T[P]>; };
/**
 * Language-specific core services to be partially overridden via dependency injection.
 */
type PartialLangiumCoreServices = DeepPartial<LangiumCoreServices>;
/**
 * Shared core services to be partially overridden via dependency injection.
 */
type PartialLangiumSharedCoreServices = DeepPartial<LangiumSharedCoreServices>;
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/default-module.d.ts
/**
 * Context required for creating the default language-specific dependency injection module.
 */
interface DefaultCoreModuleContext {
 ...
 */
interface DefaultSharedCoreModuleContext {
  /**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/completion-parser-builder.d.ts
declare function createCompletionParser(services: LangiumCoreServices): LangiumCompletionParser;
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/cst-node-builder.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/indentation-aware.d.ts
type IndentationAwareDelimiter<TokenName extends string> = [begin: TokenName, end: TokenName];
interface IndentationTokenBuilderOptions<TerminalName extends string = string, KeywordName extends string = string> {
  /**
...
interface IndentationLexingReport extends LexingReport {
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/langium-parser-builder.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/parser/parser-builder-base.d.ts
declare function createParser<T extends BaseParser>(grammar: Grammar, parser: T, tokens: TokenTypeDictionary): T;
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/errors.d.ts
declare class ErrorWithLocation extends Error {
  constructor(node: CstNode | undefined, message: string);
}
declare function assertUnreachable(_: never): never;
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/utils/grammar-loader.d.ts
/**
 * Load a Langium grammar for your language from a JSON string. This is used by several services,
 * most notably the parser builder which interprets the grammar to create a parser.
 */
declare function loadGrammarFromJson(json: string): Grammar;
declare namespace ast_utils_d_exports {
  export { AstStreamOptions, DeepPartialAstNode, assignMandatoryProperties, copyAstNode, findLocalReferences, findRootNode, getContainerOfType, getDocument, hasContainerOfType, linkContentToContainer, streamAllContents, streamAst, streamContents, streamReferences };
}
/**
 * Link the `$container` and other related properties of every AST node that is directly contained
 * in the given `node`.
 */
declare function linkContentToContainer(node: AstNode): void;
/**
 ...
 */
declare function findLocalReferences(targetNode: AstNode, lookup?: AstNode): Stream<Reference>;
/**
 ...
 */
declare function copyAstNode<T extends AstNode = AstNode>(node: T, buildReference: (node: AstNode, property: string, refNode: CstNode | undefined, refText: string) => Reference<AstNode>): T;
/**
 ...
 */
type DeepPartialAstNode<T> = T extends Reference<infer U extends AstNode> ? Reference<DeepPartialAstNode<U>> : T extends AstNode ? { [K in keyof T as K extends `$${string}` | (T[K] extends (boolean | any[]) ? K : never) ? K : never]: DeepPartialAstNode<T[K]>; } & { [K in keyof T as K extends `$${string}` ? never : T[K] extends (boolean | any[]) ? never : K]?: DeepPartialAstNode<T[K]>; } : T extends Array<infer U> ? Array<DeepPartialAstNode<U>> : T;
declare namespace cst_utils_d_exports {
  export { DefaultNameRegexp, RangeComparison, compareRange, findCommentNode, findDeclarationNodeAtOffset, findLeafNodeAtOffset, findLeafNodeBeforeOffset, flattenCst, getInteriorNodes, getNextNode, getPreviousNode, getStartlineNode, inRange, isChildNode, isCommentNode, streamCst, toDocumentSegment, tokenToRange };
}
/**
...
declare function tokenToRange(token: IToken$1): Range;
...
declare function compareRange(range: Range, to: Range): RangeComparison;
declare function inRange(range: Range, to: Range): boolean;
...
declare namespace grammar_utils_d_exports {
  export { Cardinality, Operator, findAssignment, findNameAssignment, findNodeForKeyword, findNodeForProperty, findNodesForKeyword, findNodesForKeywordInternal, findNodesForProperty, getActionAtElement, getActionType, getAllReachableRules, getAllRulesUsedForCrossReferences, getCrossReferenceTerminal, getEntryRule, getExplicitRuleType, getHiddenRules, getRuleType, getRuleTypeName, getTypeName, isArrayCardinality, isArrayOperator, isCommentTerminal, isDataType, isDataTypeRule, isOptionalCardinality, terminalRegex };
}
/**
 * Returns the entry rule of the given grammar, if any. If the grammar file does not contain an entry rule,
 * the result is `undefined`.
 */
declare function getEntryRule(grammar: Grammar): ParserRule | undefined;
/**
 * Returns all hidden terminal rules of the given grammar, if any.
 */
declare function getHiddenRules(grammar: Grammar): TerminalRule[];
/**
 ...
 */
declare function getAllReachableRules(grammar: Grammar, allTerminals: boolean): Set<AbstractRule>;
/**
 ...
 */
declare function getAllRulesUsedForCrossReferences(grammar: Grammar): Set<ParserRule>;
/**
 ...
 */
declare function getCrossReferenceTerminal(crossRef: CrossReference): AbstractElement | undefined;
/**
 * Determines whether the given terminal rule represents a comment. This is true if the rule is marked
 * as `hidden` and it does not match white space. This means every hidden token (i.e. excluded from the AST)
 * that contains visible characters is considered a comment.
 */
declare function isCommentTerminal(terminalRule: TerminalRule): boolean;
/**
 ...
 */
declare function findAssignment(cstNode: CstNode): Assignment | undefined;
/**
 * Find an assignment to the `name` property for the given grammar type. This requires the `type` to be inferred
 * from a parser rule, and that rule must contain an assignment to the `name` property. In all other cases,
 * this function returns `undefined`.
 */
declare function findNameAssignment(type: AbstractType): Assignment | undefined;
declare function getActionAtElement(element: AbstractElement): Action | undefined;
type Cardinality = '?' | '*' | '+' | undefined;
type Operator = '=' | '+=' | '?=' | undefined;
declare function isOptionalCardinality(cardinality?: Cardinality, element?: AbstractElement): boolean;
 ...
 */
declare function isDataTypeRule(rule: ParserRule): boolean;
declare function isDataType(type: Type): boolean;
declare function getExplicitRuleType(rule: ParserRule): string | undefined;
declare function getTypeName(type: AbstractType | Action): string;
declare function getActionType(action: Action): string | undefined;
/**
 ...
 */
declare function getRuleTypeName(rule: AbstractRule): string;
/**
 ...
 */
declare function getRuleType(rule: AbstractRule): string;
declare function terminalRegex(terminalRule: TerminalRule): RegExp;
declare namespace regexp_utils_d_exports {
  export { NEWLINE_REGEXP, escapeRegExp, getTerminalParts, isMultilineComment, isWhitespace, partialMatches, partialRegExp, whitespaceCharacters };
}
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
...
declare namespace index_d_exports {
  export { AbstractAstReflection, AbstractCstNode, AbstractLangiumParser, AbstractParserErrorMessageProvider, AbstractThreadedAsyncParser, AstNode, AstNodeDescription, AstNodeDescriptionProvider, AstNodeLocator, AstNodeRegionWithAssignments, AstNodeTypesWithCrossReferences, AstNodeWithComment, AstNodeWithTextRegion, AstReflection, AstTypeList, ast_utils_d_exports as AstUtils, AsyncDisposable, AsyncParser, BaseParser, BiMap, BuildOptions, cancellation_d_exports as Cancellation, CommentProvider, CompletionParserResult, CompositeCstNode, CompositeCstNodeImpl, ConfigurationInitializedParams, ConfigurationProvider, ConfigurationSectionUpdate, ConfigurationSectionUpdateListener, ContextCache, CrossReferencesOfAstNodeType, CstNode, CstNodeBuilder, cst_utils_d_exports as CstUtils, DEFAULT_TOKENIZE_OPTIONS, DONE_RESULT, DatatypeSymbol, DeepPartial, DefaultAstNodeDescriptionProvider, DefaultAstNodeLocator, DefaultAsyncParser, DefaultCommentProvider, DefaultConfigurationProvider, DefaultCoreModuleContext, DefaultDocumentBuilder, DefaultDocumentValidator, DefaultHydrator, DefaultIndexManager, DefaultJsonSerializer, DefaultLangiumDocumentFactory, DefaultLangiumDocuments, DefaultLexer, DefaultLexerErrorMessageProvider, DefaultLinker, DefaultNameProvider, DefaultReferenceDescriptionProvider, DefaultReferences, DefaultScopeComputation, DefaultScopeProvider, DefaultServiceRegistry, DefaultSharedCoreModuleContext, DefaultTokenBuilder, DefaultValueConverter, DefaultWorkspaceLock, DefaultWorkspaceManager, Deferred, DehydrateContext, DiagnosticData, DiagnosticInfo, Disposable, DisposableCache, DocumentBuildListener, DocumentBuildState, DocumentBuilder, DocumentCache, DocumentPhaseListener, DocumentSegment, DocumentState, DocumentUpdateListener, DocumentValidator, DocumentationProvider, EMPTY_SCOPE, EMPTY_STREAM, Emitter, EmitterOptions, EmptyFileSystem, EmptyFileSystemProvider, ErrorWithLocation, Event, FileSelector, FileSystemFilter, FileSystemNode, FileSystemProvider, FindReferencesOptions, FlatStream, GenericAstNode, Grammar, ast_d_exports as GrammarAST, GrammarConfig, grammar_utils_d_exports as GrammarUtils, HydrateContext, Hydrator, IParserConfig, IParserDefinitionError, IndentationAwareLexer, IndentationAwareTokenBuilder, IndentationLexingReport, IndentationTokenBuilderOptions, IndexManager, JSDocComment, JSDocDocumentationProvider, JSDocElement, JSDocInline, JSDocLine, JSDocParagraph, JSDocParseOptions, JSDocRenderOptions, JSDocTag, JSDocValue, JsonDeserializeOptions, JsonSerializeOptions, JsonSerializer, LangiumCompletionParser, LangiumCoreServices, LangiumDefaultCoreServices, LangiumDefaultSharedCoreServices, LangiumDocument, LangiumDocumentFactory, LangiumDocuments, LangiumGeneratedCoreServices, LangiumGeneratedSharedCoreServices, LangiumParser, LangiumParserErrorMessageProvider, LangiumSharedCoreServices, LanguageMetaData, LeafCstNode, LeafCstNodeImpl, Lexer$1 as Lexer, LexerResult, LexingDiagnostic, LexingDiagnosticSeverity, LexingMode, LexingReport, Linker, LinkingError, LinkingErrorData, MapScope, MaybePromise, MinusOne, Module, MultiMap, Mutable, NameProvider, NamedAstNode, OperationCancelled, ParseResult, ParserOptions, ParserWorker, PartialLangiumCoreServices, PartialLangiumSharedCoreServices, PrecomputedScopes, Properties, PropertyType, Reduction, Reference, ReferenceDescription, ReferenceDescriptionProvider, ReferenceInfo, References, regexp_utils_d_exports as RegExpUtils, ResolvedReference, RootCstNode, RootCstNodeImpl, Scope, ScopeComputation, ScopeOptions, ScopeProvider, ServiceRegistry, SimpleCache, Stream, StreamImpl, StreamScope, TextDocument, TextDocumentProvider, TokenBuilder, TokenBuilderOptions, TokenizeMode, TokenizeOptions, TreeIterator, TreeStream, TreeStreamImpl, TypeMetaData, TypeProperty, URI$1 as URI, UriUtils, ValidationAcceptor, ValidationCategory, ValidationCheck, ValidationChecks, ValidationOptions, ValidationPreparation, ValidationRegistry, ValidationSeverity, ValueConverter, ValueType, WorkerMessageCallback, WorkerMessagePost, WorkspaceCache, WorkspaceFolder, WorkspaceLock, WorkspaceManager, assertUnreachable, createCompletionParser, createDefaultCoreModule, createDefaultSharedCoreModule, createGrammarConfig, createLangiumParser, createParser, delayNextTick, diagnosticData, eagerLoad, getDiagnosticRange, indentationBuilderDefaultOptions, inject, interruptAndCheck, isAstNode, isAstNodeDescription, isAstNodeWithComment, isCompositeCstNode, isIMultiModeLexerDefinition, isJSDoc, isLeafCstNode, isLinkingError, isNamed, isOperationCancelled, isReference, isRootCstNode, isTokenTypeArray, isTokenTypeDictionary, loadGrammarFromJson, parseJSDoc, prepareLangiumParser, setInterruptionPeriod, startCancelableOperation, stream, toDiagnosticData, toDiagnosticSeverity };
}
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/progress.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/configuration.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/workspaceFolder.d.ts
interface WorkspaceFolders {
  getWorkspaceFolders(): Promise<WorkspaceFolder[] | null>;
  onDidChangeWorkspaceFolders: Event<WorkspaceFoldersChangeEvent>;
}
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/callHierarchy.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/semanticTokens.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/showDocument.d.ts
interface ShowDocumentFeatureShape {
  showDocument(params: ShowDocumentParams): Promise<ShowDocumentResult>;
}
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/fileOperations.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/linkedEditingRange.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/typeHierarchy.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/inlineValue.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/foldingRange.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/inlayHint.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/diagnostic.d.ts
/**
 * Shape of the linked editing feature
 *
 * @since 3.16.0
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/textDocuments.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/notebook.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/moniker.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vscode-languageserver@9.0.1/node_modules/vscode-languageserver/lib/common/server.d.ts
...
interface _Connection<PConsole = _, PTracer = _, PTelemetry = _, PClient = _, PWindow = _, PWorkspace = _, PLanguages = _, PNotebooks = _> {
   ...
   * @param handler The corresponding handler.
   */
  onWillSaveTextDocumentWaitUntil(handler: RequestHandler<WillSaveTextDocumentParams, TextEdit[] | undefined | null, void>): Disposable$1;
  /**
   ...
   * @param handler The corresponding handler.
   */
  onDocumentFormatting(handler: ServerRequestHandler<DocumentFormattingParams, TextEdit[] | undefined | null, never, void>): Disposable$1;
  /**
   * Installs a handler for the document range formatting request.
   *
   * @param handler The corresponding handler.
   */
  onDocumentRangeFormatting(handler: ServerRequestHandler<DocumentRangeFormattingParams, TextEdit[] | undefined | null, never, void>): Disposable$1;
  /**
   * Installs a handler for the document on type formatting request.
   *
   * @param handler The corresponding handler.
   */
  onDocumentOnTypeFormatting(handler: RequestHandler<DocumentOnTypeFormattingParams, TextEdit[] | undefined | null, void>): Disposable$1;
  /**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/call-hierarchy-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/code-action.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/code-lens-provider.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/declaration-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/definition-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/document-highlight-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/document-link-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/node-kind-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/document-symbol-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/document-update-handler.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/execute-command-handler.d.ts
interface ExecuteCommandHandler {
  get commands(): string[];
  executeCommand(name: string, args: any[], cancelToken?: CancellationToken): Promise<unknown>;
}
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/file-operation-handler.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/folding-range-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/formatter.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/fuzzy-matcher.d.ts
/******************************************************************************
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/hover-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/implementation-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/inlay-hint-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/language-server.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/references-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/rename-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/semantic-token-provider.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/signature-help-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/type-hierarchy-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/type-provider.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/workspace-symbol-provider.d.ts
/**
...
declare class DefaultWorkspaceSymbolProvider implements WorkspaceSymbolProvider {
  protected readonly indexManager: IndexManager;
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/normalized-text-documents.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/lsp-services.d.ts
/**
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/completion/follow-element-computation.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/langium@3.5.0/node_modules/langium/lib/lsp/completion/completion-provider.d.ts
...
//#endregion
export { cancellation_d_exports as $, DiagnosticInfo as A, DefaultNameProvider as B, CodeLensParams as C, RequestType as D, NotificationType as E, DefaultScopeProvider as F, AstNodeDescription as G, AsyncDisposable as H, Scope as I, ReferenceInfo as J, CstNode as K, JSDocDocumentationProvider as L, DefaultValueConverter as M, ValueType as N, DefaultDocumentValidator as O, MaybePromise as P, PrecomputedScopes as Q, DefaultIndexManager as R, CodeActionParams as S, DocumentSymbolParams as T, Disposable as U, WorkspaceCache as V, AstNode as W, LangiumDocument as X, DefaultLangiumDocuments as Y, LangiumDocumentFactory as Z, CodeLensProvider as _, TextEdit as _t, LangiumServices as a, CodeLens as at, DefaultWorkspaceManager as b, ast_d_exports as bt, AbstractSemanticTokenProvider as c, Diagnostic as ct, AbstractFormatter as d, DocumentSymbol as dt, CancellationToken as et, FormattingRegion as f, FormattingOptions as ft, DefaultDocumentHighlightProvider as g, SymbolKind as gt, DocumentLinkProvider as h, Range as ht, NextFeature as i, CodeAction as it, DefaultScopeComputation as j, ValidationOptions as k, SemanticTokenAcceptor as l, DocumentHighlight as lt, NodeKindProvider as m, Location as mt, CompletionContext as n, FileSystemNode as nt, LangiumSharedServices as o, Command as ot, DocumentSymbolProvider as p, Hover as pt, Reference as q, DefaultCompletionProvider as r, FileSystemProvider as rt, DefaultWorkspaceSymbolProvider as s, CompletionItemKind as st, CompletionAcceptor as t, Stream as tt, AstNodeHoverProvider as u, DocumentLink as ut, CodeActionProvider as v, WorkspaceFolder as vt, DocumentLinkParams as w, BuildOptions as x, URI$1 as xt, index_d_exports as y, Keyword as yt, ReferenceDescription as z };