...
import { Bi as NodeId, Bt as DeploymentRelationship, C as ComputedView, Ci as _aux_d_exports, Ct as ViewManualLayoutSnapshot, Di as toComputed, Er as RelationshipArrowType, Ft as DeployedInstance, Gr as Any, Gt as ElementStyle, Hi as ProjectId, Ii as GroupElementKind, It as DeploymentElement, Jr as AnyParsed, Kr as AnyComputed, M as ViewWithType, Mi as EdgeId, Mt as Specification, O as ProcessedView, Qr as DeploymentKind, Ri as IconUrl, Rt as DeploymentNode, Si as ViewId, T as LayoutedView, Ui as RelationId, Wt as Element, Xr as DeploymentFqn, Yi as ViewId$1, Yr as Aux, Zr as DeploymentId, _ as AuxFromLikeC4ModelData, _a as Link, _i as Tags, aa as _stage, b as LikeC4ModelData, bi as UnknownLayouted, ci as Metadata, di as RelationId$1, ea as scalar_d_exports, ei as ElementId, en as ModelGlobals, f as AuxFromDump, fi as RelationKind, fr as FqnRef, gi as Tag, ha as IteratorLike, hi as StrictViewId, ii as LooseElementId, kr as RelationshipLineType, li as MetadataKey, mi as Stage, mr as Color, ni as Fqn, nn as DynamicViewDisplayVariant, oa as _type, oi as LooseTag, p as LikeC4ModelDump, qr as AnyLayouted, qt as Relationship, ri as LooseDeploymentId, rr as WhereOperator, si as LooseViewId, ti as ElementKind, tt as ComputedNodeStyle, u as RichTextOrEmpty, ui as ProjectId$1, v as ComputedLikeC4ModelData, vi as Unknown, wt as LikeC4Project, x as ParsedLikeC4ModelData, xi as UnknownParsed, y as LayoutedLikeC4ModelData, ya as NonEmptyArray, yi as UnknownComputed, yr as ElementShape } from "./index.mjs";
import { i as BBox } from "./index2.mjs";
import { o as LikeC4Styles } from "./index3.mjs";
import { t as DefaultMap } from "./default-map.mjs";
...
type NodesIterator<M extends Any, V extends ProcessedView<M> = $View<M>> = IteratorLike<NodeModel<M, V>>;
declare class NodeModel<A extends Any = Any, V extends ProcessedView<A> = $View<A>> implements WithTags<A> {
  readonly Aux: A;
...
declare namespace NodeModel {
  ...
  interface WithParent<A extends Any, V extends ProcessedView<A> = $View<A>> extends NodeModel<A, V> {
    readonly parent: NodeModel<A, V>;
  }
  interface WithElement<A extends Any, V extends ProcessedView<A> = $View<A>> extends NodeModel<A, V> {
    readonly kind: ElementKind<A>;
    readonly element: ElementModel<A>;
  }
  interface WithDeploymentElement<A extends Any, V extends ProcessedView<A> = $View<A>> extends NodeModel<A, V> {
    readonly kind: DeploymentKind<A>;
    readonly deployment: DeploymentElementModel<A>;
  }
  interface WithDeployedInstance<A extends Any, V extends ProcessedView<A> = $View<A>> extends NodeModel<A, V> {
    readonly kind: 'instance';
    readonly element: ElementModel<A>;
    readonly deployment: DeployedInstanceModel<A>;
  }
  interface IsGroup<A extends Any, V extends ProcessedView<A> = $View<A>> extends NodeModel<A, V> {
...
type EdgesIterator<A extends Any, V extends ProcessedView<A> = $View<A>> = IteratorLike<EdgeModel<A, V>>;
declare class EdgeModel<A extends Any = Any, V extends ProcessedView<A> = $View<A>> implements WithTags<A> {
...
declare namespace EdgeModel {
  interface WithParent<A extends Any, V extends ProcessedView<A>> extends EdgeModel<A, V> {
    readonly parent: NodeModel<A, V>;
  }
}
//#endregion
...
type ViewsIterator<A extends Any, V extends ProcessedView<A> = $View<A>> = IteratorLike<LikeC4ViewModel<A, V>>;
declare class LikeC4ViewModel<A extends Any = Any, V extends ProcessedView<A> = $View<A>> implements WithTags<A> {
  #private;
  /**
   * Don't use in runtime, only for type inference
   */
...
declare namespace LikeC4ViewModel {
  ...
  interface ElementView<A extends Any, V extends ProcessedView<A> = $View<A>> extends LikeC4ViewModel<A, ViewWithType<V, 'element'>> {
    readonly mode: never;
  }
  ...
  interface DeploymentView<A extends Any, V extends ProcessedView<A> = $View<A>> extends LikeC4ViewModel<A, ViewWithType<V, 'deployment'>> {
    readonly mode: never;
  }
  interface DynamicView<A extends Any, V extends ProcessedView<A> = $View<A>> extends LikeC4ViewModel<A, ViewWithType<V, 'dynamic'>> {
...
declare class LikeC4Model<A extends Any = Any> {
   ...
   */
  get tagsFromSpecification(): Tags<A>;
  /**
