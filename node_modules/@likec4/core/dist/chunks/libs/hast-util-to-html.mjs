...
\f\r "&'<=>\``.split(``)],[`\0	
\f\r "&'<=>\``.split(``),`\0	
\f\r "&'<=>\``.split(``)]],single:[[`&'`.split(``),`"&'\``.split(``)],[`\0&'`.split(``),`\0"&'\``.split(``)]],double:[[`"&`.split(``),`"&'\``.split(``)],[`\0"&`.split(``),`\0"&'\``.split(``)]]};function element(e,t,n,r){let i=r.schema,a=i.space!==`svg`&&r.settings.omitOptionalTags,o=i.space===`svg`?r.settings.closeEmptyElements:r.settings.voids.includes(e.tagName.toLowerCase()),s=[],c;i.space===`html`&&e.tagName===`svg`&&(r.schema=w);let l=serializeAttributes(r,e.properties),u=r.all(i.space===`html`&&e.tagName===`template`?e.content:e);return r.schema=i,u&&(o=!1),(l||!a||!X(e,t,n))&&(s.push(`<`,e.tagName,l?` `+l:``),o&&(i.space===`svg`||r.settings.closeSelfClosing)&&(c=l.charAt(l.length-1),(!r.settings.tightSelfClosing||c===`/`||c&&c!==`"`&&c!==`'`)&&s.push(` `),s.push(`/`)),s.push(`>`)),s.push(u),!o&&(!a||!Y(e,t,n))&&s.push(`</`+e.tagName+`>`),s.join(``)}function serializeAttributes(e,t){let n=[],r=-1,i;if(t){for(i in t)if(t[i]!==null&&t[i]!==void 0){let r=serializeAttribute(e,i,t[i]);r&&n.push(r)}}for(;++r<n.length;){let t=e.settings.tightAttributes?n[r].charAt(n[r].length-1):void 0;r!==n.length-1&&t!==`"`&&t!==`'`&&(n[r]+=` `)}return n.join(``)}function serializeAttribute(e,t,r){let i=find(e.schema,t),a=e.settings.allowParseErrors&&e.schema.space===`html`?0:1,o=+!e.settings.allowDangerousCharacters,s=e.quote,c;if(i.overloadedBoolean&&(r===i.attribute||r===``)?r=!0:(i.boolean||i.overloadedBoolean)&&(typeof r!=`string`||r===i.attribute||r===``)&&(r=!!r),r==null||r===!1||typeof r==`number`&&Number.isNaN(r))return``;let l=stringifyEntities(i.attribute,Object.assign({},e.settings.characterReferences,{subset:Z.name[a][o]}));return r===!0||(r=Array.isArray(r)?(i.commaSeparated?stringify$1:stringify)(r,{padLeft:!e.settings.tightCommaSeparatedLists}):String(r),e.settings.collapseEmptyAttributes&&!r)?l:(e.settings.preferUnquoted&&(c=stringifyEntities(r,Object.assign({},e.settings.characterReferences,{attribute:!0,subset:Z.unquoted[a][o]}))),c!==r&&(e.settings.quoteSmart&&n(r,s)>n(r,e.alternative)&&(s=e.alternative),c=s+stringifyEntities(r,Object.assign({},e.settings.characterReferences,{subset:(s===`'`?Z.single:Z.double)[a][o],attribute:!0}))+s),l+(c&&`=`+c))}const Q=[`<`,`&`];function text(e,t,n,r){return n&&n.type===`element`&&(n.tagName===`script`||n.tagName===`style`)?e.value:stringifyEntities(e.value,Object.assign({},r.settings.characterReferences,{subset:Q}))}function raw(e,t,n,r){return r.settings.allowDangerousHtml?e.value:text(e,t,n,r)}function root(e,t,n,r){return r.all(e)}const $=zwitch(`type`,{invalid,unknown,handlers:{comment,doctype,element,raw,root,text}});function invalid(e){throw Error("Expected node, not `"+e+"`")}function unknown(e){throw Error("Cannot compile unknown node `"+e.type+"`")}const ee={},te={},ne=[];function toHtml(e,t){let n=t||ee,r=n.quote||`"`,i=r===`"`?`'`:`"`;if(r!==`"`&&r!==`'`)throw Error("Invalid quote `"+r+"`, expected `'` or `\"`");return{one,all,settings:{omitOptionalTags:n.omitOptionalTags||!1,allowParseErrors:n.allowParseErrors||!1,allowDangerousCharacters:n.allowDangerousCharacters||!1,quoteSmart:n.quoteSmart||!1,preferUnquoted:n.preferUnquoted||!1,tightAttributes:n.tightAttributes||!1,upperDoctype:n.upperDoctype||!1,tightDoctype:n.tightDoctype||!1,bogusComments:n.bogusComments||!1,tightCommaSeparatedLists:n.tightCommaSeparatedLists||!1,tightSelfClosing:n.tightSelfClosing||!1,collapseEmptyAttributes:n.collapseEmptyAttributes||!1,allowDangerousHtml:n.allowDangerousHtml||!1,voids:n.voids||E,characterReferences:n.characterReferences||te,closeSelfClosing:n.closeSelfClosing||!1,closeEmptyElements:n.closeEmptyElements||!1},schema:n.space===`svg`?w:C,quote:r,alternative:i}.one(Array.isArray(e)?{type:`root`,children:e}:e,void 0,void 0)}function one(e,t,n){return $(e,t,n,this)}function all(e){let t=[],n=e&&e.children||ne,r=-1;for(;++r<n.length;)t[r]=this.one(n[r],r,e);return t.join(``)}export{C as a,normalize as c,parse$1 as i,T as n,w as o,parse as r,find as s,toHtml as t};